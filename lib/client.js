	...
	factory: (require) => {
		...
		*  order; cancelled folds into the 已终止 zone below the board (no lane). */
		function lanesOf(todos) {
			...
			const pick = (status) => todos.filter((todo) => laneStatusOf(todo) === status).sort(byDdl);
			return {
				lanes: [
					{
						key: "backlog",
				...
				cancelled: todos.filter((todo) => laneStatusOf(todo) === "cancelled")
			};
		}
		...
		*  without hand-editing host config. */
		...
		function TodoPane(props) {
			...
			const { lanes, cancelled } = (0, react.useMemo)(() => lanesOf(visible), [visible]);
			...
			const runVerb = (verb, todoId, note) => {
				setBusyId(todoId);
				(verb === "approve" ? props.approveTodo(todoId, note) : verb === "accept" ? props.acceptTodo(todoId, note) : verb === "return" ? props.returnTodo(todoId, note) : verb === "cancel" ? props.cancelTodo(todoId, note) : props.reopenTodo(todoId)).then((result) => {
					setBusyId("");
					setNoteFor(null);
					setNoteDraft("");
					if (result.ok) {
			...
			const renderCard = (todo) => {
				...
				return (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						description !== "" && status !== "done" && status !== "cancelled" && (0, react_jsx_runtime.jsx)("div", {
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								status === "backlog" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									(0, react_jsx_runtime.jsx)("button", {
										type: "button",
								...
								status === "todo" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									(0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: `${todo_pane_module_css_default.verb} ${todo_pane_module_css_default.verbPrimary}`,
								...
								status === "in_progress" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									(0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: todo_pane_module_css_default.verb,
										"data-testid": `yzj-todo-done-${todoId}`,
								...
								status === "in_review" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: `${todo_pane_module_css_default.verb} ${todo_pane_module_css_default.verbPrimary}`,
								...
								status === "done" && (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: todo_pane_module_css_default.verb,
								...
								status === "cancelled" && (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: todo_pane_module_css_default.verb,
									"data-testid": `yzj-todo-reopen-${todoId}`,
									disabled: busy,
