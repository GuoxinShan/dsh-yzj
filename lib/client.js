			...
			const openSourceModal = async () => {
				...
				if (wsResult.ok) {
					...
					for (const ws of workspaces) {
						...
						const kbName = asString$5(ws.name) || kbId;
						dirs.push({
							id: kbId,
							label: `${kbName}（整库）`
						});
																...
																(0, react_jsx_runtime.jsxs)("div", {
																	...
																	children: [
																		(0, react_jsx_runtime.jsxs)("div", {
																			...
																			children: [asString$5(entry.changeType) !== "" && (0, react_jsx_runtime.jsx)("span", {
																		...
																		refList.length > 0 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("div", {
																			className: advance_pane_module_css_default.refsHead,
																			children: [(0, react_jsx_runtime.jsxs)("span", { children: [
																				"原始信息 ",
																				refList.length,
																				" 条"
																			] }), refList.length > 2 && (0, react_jsx_runtime.jsx)("button", {
																				type: "button",
																				className: advance_pane_module_css_default.jump,
																				"data-testid": `yzj-advance-entry-toggle-${index}`,
																				onClick: toggleExpanded,
																				children: expanded ? "收起" : `展开全部 ${refList.length} 条`
																			})]
																		}), (0, react_jsx_runtime.jsx)("span", {
																		...
																		(asString$5(entry.sourceType) !== "" || asString$5(entry.actor) === "user") && (0, react_jsx_runtime.jsx)("div", {
																			className: advance_pane_module_css_default.timeMeta,
																			children: (0, react_jsx_runtime.jsx)("span", { children: asString$5(entry.actor) === "user" ? `${asString$5(entry.sourceType) === "" ? "" : `${asString$5(entry.sourceType)} · `}你的判断` : `记录自 ${asString$5(entry.sourceType)}` })
																		})
																	]
																})
															]
