									...
									children: [
										...
										(0, react_jsx_runtime.jsxs)("section", {
											...
											children: [
												(0, react_jsx_runtime.jsxs)("div", {
													className: advance_pane_module_css_default.sectionHead,
													children: [(0, react_jsx_runtime.jsx)("h2", { children: "推进演进" }), (0, react_jsx_runtime.jsx)("small", { children: "多个事元折叠出演进 · 展开看每条事元引用的原始信息" })]
												}),
																...
																(0, react_jsx_runtime.jsxs)("div", {
																	...
																	children: [
																		...
																		(0, react_jsx_runtime.jsxs)("div", {
																			...
																			children: [(0, react_jsx_runtime.jsxs)("span", { children: [asString$5(entry.sourceType), asString$5(entry.actor) === "user" ? " · 你的判断" : ""] }), (asString$5(entry.detail) !== "" || refList.length > 2) && (0, react_jsx_runtime.jsx)("button", {
																				type: "button",
																				className: advance_pane_module_css_default.jump,
																				"data-testid": `yzj-advance-entry-toggle-${index}`,
																				onClick: toggleExpanded,
																				children: expanded ? "收起" : `${refList.length > 2 ? `展开全部 ${refList.length} 条原始信息` : "查看详情"}`
																			})]
																		})
																	]
																})
