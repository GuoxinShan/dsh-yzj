window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ImBody(meta, openPanel) {
			...
			if (messages.length > 0 && asString$11(asRecord$19(messages[0]).sendTime) !== "") return (0, react_jsx_runtime.jsx)("div", {
				className: cards_module_css_default.rows,
		...
		*/
		...
		var home_module_css_default = {
			...
			"roomDomainPane": "_1NmHsa_roomDomainPane",
			...
			"workbenchTabActive": "_1NmHsa_workbenchTabActive",
			...
			"workbenchTab": "_1NmHsa_workbenchTab",
			...
			"roomShellBody": "_1NmHsa_roomShellBody",
			...
			"im": "_1NmHsa_im",
			"workbenchTabs": "_1NmHsa_workbenchTabs",
		...
		function YzjYunzhijiaDock(props) {
			...
			return (0, react_jsx_runtime.jsxs)("nav", {
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsxs)("button", {
						type: "button",
						className: `${home_module_css_default.yzjDockEntry} ${seated ? home_module_css_default.yzjDockEntryActive : ""}`,
						title: "云之家",
						"aria-pressed": seated,
		...
		*/
		function MessageBody({ message, onOpenImage, onOpenPdf, inject }) {
			...
			if (msgType === "other" && asString$9(param.title) === "" && asRecord$12(param.interactiveCard).cardJson === void 0) return (0, react_jsx_runtime.jsx)("span", {
				className: panel_module_css_default.msgSystem,
				children: content === "" ? "(系统消息)" : emojiText(content)
			});
			if (asString$9(param.sysType) === "withdrawMsg") return (0, react_jsx_runtime.jsx)("span", {
				className: panel_module_css_default.msgSystem,
		...
		*/
		function artifactOf(entry) {
			...
			const ext = asString$8(param.ext);
			return {
								...
								return (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [(0, react_jsx_runtime.jsx)(StatusDot, {
										...
										children: [(0, react_jsx_runtime.jsx)("span", {
											...
											children: [
												asString$6(todo.ddl) !== "" && (0, react_jsx_runtime.jsxs)("span", {
									...
									children: [
										...
										asString$6(todo.assignee) !== "" && (0, react_jsx_runtime.jsxs)("div", {
											className: todo_pane_module_css_default.detailLine,
											children: ["负责人：", asString$6(todo.assignee)]
										}),
										asString$6(todo.log) !== "" && (0, react_jsx_runtime.jsx)("div", {
		...
		*/
		function YzjRoomShell(props) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsx)("div", {
					className: home_module_css_default.workbenchTabs,
					role: "tablist",
					"aria-label": "云之家",
					"data-testid": "yzj-workbench-tabs",
					children: WORKBENCH_TABS.map((tab) => {
						const selected = domain === tab.domain;
						return (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							role: "tab",
							"aria-selected": selected,
							className: `${home_module_css_default.workbenchTab} ${selected ? home_module_css_default.workbenchTabActive : ""}`,
					...
					className: home_module_css_default.roomShellBody,
					children: domainPane !== null ? (0, react_jsx_runtime.jsx)("div", {
						className: home_module_css_default.roomDomainPane,
						children: domainPane
					}) : (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(YzjConvList, {
						sessionId: props.sessionId,
