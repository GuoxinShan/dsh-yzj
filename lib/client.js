							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										(0, react_jsx_runtime.jsxs)("section", {
											...
											children: [
												...
												detail.sources.length === 0 ? (0, react_jsx_runtime.jsx)("p", {
													...
													children: detail.sources.map((source, index) => {
										...
										detail.sources.some((source) => asString$5(source.sourceType) === "文档") && (0, react_jsx_runtime.jsxs)("section", {
											className: advance_pane_module_css_default.section,
											children: [(0, react_jsx_runtime.jsxs)("div", {
												className: advance_pane_module_css_default.sectionHead,
												children: [(0, react_jsx_runtime.jsx)("h2", { children: "已有产物" }), (0, react_jsx_runtime.jsx)("small", { children: "仍在产物管理" })]
											}), (0, react_jsx_runtime.jsx)("div", {
												className: advance_pane_module_css_default.sourceList,
												children: detail.sources.filter((source) => asString$5(source.sourceType) === "文档").map((source, index) => {
													const productRef = stripRefPrefix(asString$5(source.ref));
													...
													return (0, react_jsx_runtime.jsxs)("div", {
														...
														children: [(0, react_jsx_runtime.jsx)("span", {
															...
															className: advance_pane_module_css_default.sourceCopy,
															children: productHref !== null ? (0, react_jsx_runtime.jsx)("a", {
																href: productHref,
																target: "_blank",
																rel: "noreferrer",
																title: productRef,
																children: (0, react_jsx_runtime.jsx)("b", { children: asString$5(source.label) })
															}) : (0, react_jsx_runtime.jsx)("b", { children: asString$5(source.label) })
														})]
													}, `p${index}`);
												})
											})]
					...
					threadModalOpen && (0, react_jsx_runtime.jsx)("div", {
						...
						children: (0, react_jsx_runtime.jsxs)("section", {
							...
							children: [
								...
								groupOptions.length > 0 && (0, react_jsx_runtime.jsx)("div", {
								...
								(0, react_jsx_runtime.jsxs)("label", {
									className: advance_pane_module_css_default.fieldLabel,
									children: ["或输入线程 token（im: / doc: / todo: / event: / file:）", (0, react_jsx_runtime.jsx)("input", {
										value: threadToken,
