	...
	factory: (require) => {
							...
							children: [
								...
								askDraft !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
										askDraft.kind === "export" ? "复盘沉淀已预备" : askDraft.kind === "patrol" ? "巡检请求已预备" : askDraft.kind === "dream" ? "Dream 抽取已预备" : "验收问题已预备",
										" · ",
										askDraft.title,
		...
		*/
		...
		var advance_pane_module_css_default = {
			...
			"subGroupLabel": "Y6ZzqW_subGroupLabel",
		...
		*/
		...
		function YzjAdvancePane(props) {
			...
			const [showAllSources, setShowAllSources] = (0, react.useState)(false);
			const [draft, setDraft] = (0, react.useState)({
				title: "",
				goal: "",
				metrics: "",
			...
			const openSourceModal = async () => {
				...
				if (wsResult.ok) {
					const workspaces = asArray$6(wsResult.value).map(asRecord$8);
					const mine = workspaces.find((row) => asString$5(row.name).includes("我的知识")) ?? workspaces[0];
					const kbId = asString$5(mine?.id);
					if (kbId !== "") {
						dirs.push({
							id: kbId,
							label: `${asString$5(mine?.name) || "我的知识"}（整库）`
						});
						const docsResult = await props.inject.fetchDocs(kbId);
						if (docsResult.ok) {
							const nodes = asArray$6(docsResult.value).map(asRecord$8);
							for (const node of nodes) {
								const id = asString$5(node.id);
								const title = asString$5(node.title);
								const hasChildren = node.hasChildren === true || typeof node.childrenCount === "number" && node.childrenCount > 0;
								if (id !== "" && title !== "" && hasChildren) dirs.push({
									id,
									label: title
								});
							}
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									dreamLine !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: advance_pane_module_css_default.dreamLine,
										"data-testid": "yzj-advance-dream-status",
										children: [dreamLine, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											type: "button",
											className: advance_pane_module_css_default.patrolBtn,
							...
							queues.closed.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									...
									return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: advance_pane_module_css_default.queueTitle,
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { className: `${advance_pane_module_css_default.dot} ${advance_pane_module_css_default[`dot_${dotToneOf(asString$5(item.stage))}`]}` }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: asString$5(item.title) === "" ? "(无标题)" : asString$5(item.title) })]
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [STAGE_LABEL[asString$5(item.stage)] ?? asString$5(item.stage), asString$5(item.latest) === "" ? "" : ` · ${asString$5(item.latest)}`] })]
									}, id);
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
																		...
																		/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
																			...
																			children: [
																				...
																				asArray$6(entry.refs).length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
																					...
																					children: [...new Set(asArray$6(entry.refs).map((ref) => asString$5(ref)).filter((ref) => ref !== ""))].map((raw) => {
																						const id = stripRefPrefix(raw);
																						const kind = refKindOf(asString$5(entry.sourceType));
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
											...
											children: detail.contextSources.map((source, index) => {
												...
												return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
													...
													children: [
														...
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: asString$5(source.label) === "" ? token : asString$5(source.label) }),
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", { children: asString$5(source.addedBy) === "user" ? "你关联" : "AI 关联" }),
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
															type: "button",
															"aria-label": "解除关联",
										...
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												className: advance_pane_module_css_default.sectionHead,
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", { children: "事元" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: "跨工作现场" })]
											}),
											detail.sources.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
												...
												children: (showAllSources ? detail.sources : detail.sources.slice(-3)).map((source, index) => {
													const sourceRef = stripRefPrefix(asString$5(source.ref));
													const sourceHref = refHref(refKindOf(asString$5(source.sourceType)), sourceRef);
													return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
														...
														children: [
															...
															/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
																...
																children: [sourceHref !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
																	href: sourceHref,
																	target: "_blank",
																	rel: "noreferrer",
																	title: sourceRef,
																	children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: asString$5(source.label) })
																}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: asString$5(source.label) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: asString$5(source.at) })]
															}),
											...
											detail.sources.length > 3 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
												type: "button",
												className: advance_pane_module_css_default.more,
												...
												children: showAllSources ? "收起" : `展开全部 ${detail.sources.length} 条`
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					...
					sourceModalOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									className: advance_pane_module_css_default.sideNote,
									children: "IM 群与知识库目录都是持续渠道：巡检按订阅取增量（群=新消息，目录=新增/更新文档）。关联即订阅，解除不删事元。"
								}),
