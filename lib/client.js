											...
											children: [
												...
												stage === "decision-needed" && (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [latestDecision !== void 0 && decisionParsed !== void 0 ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
														...
														(0, react_jsx_runtime.jsx)("p", {
															className: advance_pane_module_css_default.quiet,
															children: "这条变化把事项推到了「待你决定」，但没有带上建议动作；你可以直接拍板，或到时间线点「问助手」让它补齐建议。"
														})
													] }), (0, react_jsx_runtime.jsxs)("div", {
																...
																(0, react_jsx_runtime.jsxs)("div", {
																	...
																	children: [(0, react_jsx_runtime.jsxs)("button", {
																		...
																		(0, react_jsx_runtime.jsxs)("div", {
																			...
																			children: [(asString$5(entry.sourceType) !== "" || asString$5(entry.actor) === "user") && (0, react_jsx_runtime.jsx)("span", { children: asString$5(entry.actor) === "user" ? `${asString$5(entry.sourceType) === "" ? "" : `${asString$5(entry.sourceType)} · `}你的判断` : `记录自 ${asString$5(entry.sourceType)}` }), (0, react_jsx_runtime.jsx)("button", {
																				type: "button",
																				...
																				onClick: () => {
																					...
																					setAdvanceAskDraft({
																						advanceId,
																						title,
																						text: discussAskText(advanceId, title, asString$5(entry.at), asString$5(entry.summary)),
																						kind: "discuss"
																					});
																					setWorkbenchDomain("im");
																				},
