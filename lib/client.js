window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		* request a group open; the im panel consumes it and switches the timeline. */
		...
		function requestImGroupFocus(groupId) {
		...
		*/
		...
		function YzjPanel(props) {
			...
			(0, react.useEffect)(() => subscribeImGroupFocus((groupId) => {
				openGroupRef.current(groupId);
			}), []);
