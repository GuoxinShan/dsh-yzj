window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/workspace/packages/ui-yzj/src/client/cards.module.css.mjs
		const css$9 = ".TRbPEG_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;flex-direction:column;gap:6px;min-width:0;padding:10px 12px;font-size:14px;line-height:20px;display:flex}.TRbPEG_errorCard{border-color:var(--dsw-static-red-500)}.TRbPEG_header{align-items:center;gap:8px;min-width:0;display:flex}.TRbPEG_iconBox{background:var(--dsw-static-deepseek-100);width:28px;height:28px;color:var(--dsw-static-deepseek-600);border-radius:8px;flex:none;justify-content:center;align-items:center;display:inline-flex}.TRbPEG_title{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;overflow:hidden}.TRbPEG_tag{background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600);border-radius:999px;flex:none;margin-left:auto;padding:0 8px;font-size:11px;line-height:18px}.TRbPEG_tagRun{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-tertiary)}.TRbPEG_tagFail{background:var(--dsw-static-red-100);color:var(--dsw-static-red-500);font-weight:600}.TRbPEG_rowWrap{align-items:center;gap:6px;min-width:0;display:flex}.TRbPEG_rowWrap>*{flex:1;min-width:0}.TRbPEG_rowWrap .TRbPEG_link{flex:none}.TRbPEG_rows{flex-direction:column;gap:4px;max-height:260px;display:flex;overflow:auto}.TRbPEG_row{background:var(--dsw-alias-bg-base);border-radius:8px;flex-direction:column;gap:1px;min-width:0;padding:5px 8px;display:flex}.TRbPEG_rowTitle{text-overflow:ellipsis;white-space:nowrap;align-items:center;gap:6px;min-width:0;font-weight:500;display:flex;overflow:hidden}.TRbPEG_rowSub{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:16px;overflow:hidden}.TRbPEG_rowId{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px}.TRbPEG_avatar{object-fit:cover;border-radius:50%;flex:none;width:20px;height:20px}.TRbPEG_avatarFallback{background:var(--dsw-static-deepseek-100);width:20px;height:20px;color:var(--dsw-static-deepseek-600);border-radius:50%;flex:none;justify-content:center;align-items:center;font-size:12px;font-weight:600;display:inline-flex}.TRbPEG_link{color:var(--dsw-static-deepseek-500);text-overflow:ellipsis;white-space:nowrap;text-decoration:none;overflow:hidden}.TRbPEG_link:hover{text-decoration:underline}.TRbPEG_jump{color:var(--dsw-static-deepseek-500);cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:6px;flex:none;padding:2px 8px;font-size:12px;line-height:16px}.TRbPEG_jump:hover{background:var(--dsw-static-deepseek-100)}.TRbPEG_text{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;word-break:break-word;max-height:200px;font-size:13px;line-height:18px;overflow:auto}.TRbPEG_strongCard{border-color:var(--dsw-static-red-500);background:var(--dsw-alias-interactive-bg-hover-danger)}.TRbPEG_tagStrong{background:var(--dsw-static-red-100);color:var(--dsw-static-red-500);font-weight:600}.TRbPEG_fullText{white-space:pre-wrap;word-break:break-word;background:var(--dsw-alias-bg-base);border-radius:8px;max-height:180px;padding:6px 8px;font-size:13px;line-height:18px;overflow:auto}.TRbPEG_actions{flex-wrap:wrap;gap:6px;padding-top:2px;display:flex}.TRbPEG_action,.TRbPEG_actionPrimary{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease), border-color .12s var(--ds-ease-in-out,ease);border-radius:8px;padding:5px 14px;font-size:12px;line-height:16px}.TRbPEG_action:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-border-l3)}.TRbPEG_actionPrimary{background:var(--dsw-alias-button-info-fill);color:var(--dsw-alias-label-primary-foreground);border-color:#0000;font-weight:600}.TRbPEG_actionPrimary:hover{background:var(--dsw-alias-button-info-hover);border-color:#0000}.TRbPEG_writeId{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:10px}.TRbPEG_ccIdentity{color:var(--dsw-alias-label-secondary);padding:2px 8px 0;font-size:12px;line-height:16px}.TRbPEG_ccRefs{flex-wrap:wrap;align-items:center;gap:6px;padding:0 8px;display:flex}.TRbPEG_ccRefsLabel{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px}.TRbPEG_miniChip{background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600);border-radius:999px;flex:none;padding:2px 10px;font-size:11px;line-height:16px}.TRbPEG_terminalCancel{border-color:var(--dsw-alias-border-l3);background:var(--dsw-alias-bg-layer-1);opacity:.85}";
		...
		var cards_module_css_default = {
			"tagStrong": "TRbPEG_tagStrong",
			"rowSub": "TRbPEG_rowSub",
			"tag": "TRbPEG_tag",
			"rowTitle": "TRbPEG_rowTitle",
			"text": "TRbPEG_text",
			"rowWrap": "TRbPEG_rowWrap",
			"iconBox": "TRbPEG_iconBox",
			"avatarFallback": "TRbPEG_avatarFallback",
			"rowId": "TRbPEG_rowId",
			"action": "TRbPEG_action",
			"card": "TRbPEG_card",
			"ccRefsLabel": "TRbPEG_ccRefsLabel",
			"header": "TRbPEG_header",
			"title": "TRbPEG_title",
			"link": "TRbPEG_link",
			"ccRefs": "TRbPEG_ccRefs",
			"ccIdentity": "TRbPEG_ccIdentity",
			"avatar": "TRbPEG_avatar",
			"jump": "TRbPEG_jump",
			"fullText": "TRbPEG_fullText",
			"rows": "TRbPEG_rows",
			"terminalCancel": "TRbPEG_terminalCancel",
			"actionPrimary": "TRbPEG_actionPrimary",
			"strongCard": "TRbPEG_strongCard",
			"tagRun": "TRbPEG_tagRun",
			"row": "TRbPEG_row",
			"actions": "TRbPEG_actions",
			"errorCard": "TRbPEG_errorCard",
			"writeId": "TRbPEG_writeId",
			"tagFail": "TRbPEG_tagFail",
			"miniChip": "TRbPEG_miniChip"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/workspace/packages/ui-yzj/src/client/home.module.css.mjs
		const css$8 = ".iHN4tq_stream{flex-direction:column;flex:1 1 0;min-height:0;padding:12px 16px 24px;display:flex;overflow:auto}.iHN4tq_streamContent{flex-direction:column;gap:10px;display:flex}.iHN4tq_hint{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);border-radius:8px;padding:8px 10px;font-size:12px;line-height:18px}.iHN4tq_unbound{text-align:center;max-width:420px;color:var(--dsw-alias-label-secondary);margin:24px auto;font-size:13px;line-height:20px}.iHN4tq_row{flex-direction:row;align-items:flex-start;gap:8px;max-width:86%;display:flex}.iHN4tq_rowSelf{flex-direction:row-reverse;align-self:flex-end}.iHN4tq_rowOther{align-self:flex-start}.iHN4tq_stack{flex-direction:column;gap:4px;min-width:0;display:flex}.iHN4tq_daySep{color:var(--dsw-alias-label-tertiary);justify-content:center;margin:8px 0 4px;font-size:11px;line-height:18px;display:flex}.iHN4tq_daySep span{background:var(--dsw-alias-bg-layer-2);border-radius:999px;padding:1px 10px}.iHN4tq_meta{color:var(--dsw-alias-label-tertiary);gap:8px;font-size:11px;display:flex}.iHN4tq_bubble{white-space:pre-wrap;word-break:break-word;border-radius:10px;padding:8px 10px;font-size:14px;line-height:20px}.iHN4tq_im{background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l2)}.iHN4tq_imSelf{background:var(--dsw-static-deepseek-100);border-color:#0000}.iHN4tq_agent{background:var(--dsw-alias-bg-base);border:1px solid var(--dsw-alias-border-l2)}.iHN4tq_pending{border-color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-100)}.iHN4tq_failed{border-color:var(--dsw-static-red-500)}.iHN4tq_tag{background:var(--dsw-alias-interactive-bg-hover);border-radius:999px;align-items:center;padding:0 6px;font-size:10px;font-weight:600;display:inline-flex}.iHN4tq_chrome{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);border-radius:10px;flex-wrap:wrap;align-items:center;gap:8px;margin:0 0 6px;padding:6px 8px;font-size:12px;display:flex}.iHN4tq_chromeQuiet{align-items:center;margin:0 0 4px;padding:0 2px;display:flex}.iHN4tq_chromeLink{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:none;padding:0;font-size:12px}.iHN4tq_chromeLink:hover{color:var(--dsw-alias-label-primary)}.iHN4tq_chromeBtn{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:8px;padding:4px 10px;font-size:12px;font-weight:600}.iHN4tq_chromeBtn:hover{background:var(--dsw-alias-interactive-bg-hover)}.iHN4tq_chromePrimary{background:var(--dsw-static-deepseek-500);color:#fff;border-color:#0000}.iHN4tq_modalMask{z-index:200;background:#00000059;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.iHN4tq_modal{background:var(--dsw-alias-bg-base);width:min(520px,92vw);max-height:80vh;color:var(--dsw-alias-label-primary);border-radius:12px;padding:16px;overflow:auto;box-shadow:0 16px 48px #0003}.iHN4tq_modal h3{margin:0 0 8px;font-size:16px}.iHN4tq_modal p{color:var(--dsw-alias-label-secondary);margin:0 0 12px;font-size:13px}.iHN4tq_pick{flex-direction:column;gap:6px;margin-bottom:12px;display:flex}.iHN4tq_candidate{align-items:flex-start;gap:8px;font-size:13px;line-height:18px;display:flex}.iHN4tq_actions{justify-content:flex-end;gap:8px;margin-top:12px;display:flex}.iHN4tq_topicList{flex-wrap:wrap;align-items:center;gap:6px;display:flex}.iHN4tq_topicListLabel{color:var(--dsw-alias-label-tertiary);font-size:11px;font-weight:600}.iHN4tq_kindPill{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:999px;align-items:center;padding:2px 8px;font-size:11px;font-weight:600;display:inline-flex}.iHN4tq_topicDock{box-sizing:border-box;width:calc(100% - 2 * var(--dsh-composer-side-clearance,16px));max-width:var(--dsh-composer-card-max-width,780px);flex:none;margin:0 auto;padding:0}.iHN4tq_topicDockBtn{border:1px solid var(--dsw-alias-border-l2-darkmode-thin,var(--dsw-alias-border-l2));background:var(--dsw-specific-input-major,var(--dsw-alias-bg-base));width:100%;height:36px;box-shadow:var(--dsw-shadow-lv2,0 8px 24px #00000014);color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:22px;align-items:center;gap:10px;padding:4px 16px;display:flex}.iHN4tq_topicDockBtn:hover,.iHN4tq_topicDockBtn:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.iHN4tq_topicDockLabel{flex:none;font-size:13px;font-weight:500;line-height:18px}.iHN4tq_topicDockSummary{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.iHN4tq_roomComposerSeat{display:none}.iHN4tq_roomTimeline{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex}.iHN4tq_roomComposerHost{flex:none}.iHN4tq_roomComposer{background:0 0;border-top:none;flex-direction:column;gap:8px;padding:8px 16px 14px;display:flex;position:relative}.iHN4tq_roomComposerCard{border:1px solid var(--dsw-alias-border-l2-darkmode-thin,var(--dsw-alias-border-l2));background:var(--dsw-specific-input-major,var(--dsw-alias-bg-base));box-shadow:var(--dsw-shadow-lv2,0 8px 24px #00000014);border-radius:22px;flex-direction:column;gap:10px;padding:10px 10px 6px;display:flex}.iHN4tq_roomComposerInput{resize:none;min-height:48px;max-height:160px;color:var(--dsw-alias-label-primary);font:inherit;background:0 0;border:none;border-radius:0;flex:1;padding:4px 10px;font-size:16px;line-height:24px}.iHN4tq_roomComposerInput:focus{outline:none}.iHN4tq_roomComposerBar{justify-content:space-between;align-items:center;gap:12px;padding:2px 6px 6px;display:flex}.iHN4tq_roomComposerTools{align-items:center;gap:14px;padding:0 2px;display:flex}.iHN4tq_roomSendCircle{background:var(--dsw-alias-button-info-fill,var(--dsw-static-deepseek-500));color:#fff;cursor:pointer;border:none;border-radius:999px;flex:none;place-items:center;width:34px;height:34px;display:grid}.iHN4tq_roomSendCircle:hover:not(:disabled){background:var(--dsw-alias-button-info-hover,var(--dsw-static-deepseek-500))}.iHN4tq_roomSendCircle:disabled{opacity:.4;cursor:default}.iHN4tq_roomToolBtn,.iHN4tq_roomReplyCancel{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:0;padding:0;font-size:12px;font-weight:400}.iHN4tq_roomToolBtn:hover,.iHN4tq_roomReplyCancel:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.iHN4tq_roomReplyBar{border-left:2px solid var(--dsw-static-deepseek-500);background:var(--dsw-alias-bg-layer-1);border-radius:6px;align-items:center;gap:8px;padding:4px 8px;display:flex}.iHN4tq_roomReplyText{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-secondary);flex:1;font-size:12px;overflow:hidden}.iHN4tq_roomEmojiPanel{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex-wrap:wrap;gap:4px;padding:6px;display:flex}.iHN4tq_roomEmojiBtn{cursor:pointer;background:0 0;border:none;border-radius:4px;padding:2px 4px;font-size:18px;line-height:24px}.iHN4tq_roomEmojiBtn:hover{background:var(--dsw-alias-interactive-bg-hover)}.iHN4tq_roomRow{gap:8px;max-width:86%;margin-top:10px;display:flex}.iHN4tq_roomRowMerged{margin-top:2px}.iHN4tq_roomRowSelf{flex-direction:row-reverse;align-self:flex-end}.iHN4tq_roomRowOther{align-self:flex-start}.iHN4tq_roomAvatarSlot{flex:none;width:28px}.iHN4tq_roomStack{flex-direction:column;gap:2px;min-width:0;display:flex}.iHN4tq_roomRowSelf .iHN4tq_roomStack{align-items:flex-end}.iHN4tq_roomMeta{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.iHN4tq_roomBubble{word-break:break-word;max-width:min(525px,82%);color:var(--dsw-alias-label-primary);flex-direction:column;align-items:stretch;padding:10px 16px;font-size:16px;line-height:24px;display:flex}.iHN4tq_roomBubbleSelf{background:var(--dsw-specific-bubble,var(--dsw-static-deepseek-50));border-radius:22px}.iHN4tq_roomBubbleOther,.iHN4tq_roomBubbleAssistant{background:var(--dsw-alias-interactive-bg-hover-solid,var(--dsw-static-neutral-bluish-75));border-radius:22px}.iHN4tq_roomClamp{-webkit-line-clamp:4;word-break:break-word;white-space:pre-wrap;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.iHN4tq_roomClampToggle{color:var(--dsw-alias-state-business-primary);font:inherit;cursor:pointer;background:0 0;border:none;align-self:flex-start;padding:2px 0 0;font-size:12px}.iHN4tq_roomRowActions{opacity:0;flex-wrap:wrap;gap:8px;display:flex}.iHN4tq_roomRow:hover .iHN4tq_roomRowActions,.iHN4tq_roomRow:focus-within .iHN4tq_roomRowActions{opacity:1}.iHN4tq_roomRowActions .iHN4tq_roomAction{font:inherit;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;font-weight:500;line-height:16px}.iHN4tq_roomRowActions .iHN4tq_roomAction:hover{color:var(--dsw-static-deepseek-500)}.iHN4tq_roomRowActions .iHN4tq_roomAction:disabled{opacity:.5;cursor:default}.iHN4tq_replyChip{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-static-deepseek-500);font:inherit;cursor:pointer;border:none;border-radius:10px;align-self:flex-start;margin-top:6px;padding:2px 8px;font-size:11px;font-weight:600;display:inline-flex}.iHN4tq_artifactCard{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:8px;align-items:center;gap:8px;margin-top:6px;padding:8px;display:flex}.iHN4tq_artifactType{background:var(--dsw-alias-bg-layer-2);min-width:36px;color:var(--dsw-alias-label-secondary);letter-spacing:.04em;text-align:center;border-radius:4px;flex:none;padding:4px 6px;font-size:10px;font-weight:700}.iHN4tq_artifactMeta{flex-direction:column;gap:2px;min-width:0;display:flex}.iHN4tq_artifactName{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:16px}.iHN4tq_artifactNote{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.iHN4tq_daySep{max-width:none;color:var(--dsw-alias-label-tertiary);align-self:stretch;align-items:center;gap:8px;margin:14px 0 4px;font-size:11px;line-height:16px;display:flex}.iHN4tq_daySep:before,.iHN4tq_daySep:after{content:\"\";background:var(--dsw-alias-border-l2);flex:1;height:1px}.iHN4tq_groupSpaceSection{color:var(--dsw-alias-label-tertiary);padding:6px 8px 2px;font-size:11px;font-weight:600}.iHN4tq_topicChip,.iHN4tq_handBtn{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:8px;padding:2px 8px;font-size:11px;font-weight:600}.iHN4tq_topicChip:hover,.iHN4tq_handBtn:hover{background:var(--dsw-alias-interactive-bg-hover)}.iHN4tq_handBtn:disabled{opacity:.5;cursor:default}.iHN4tq_groupSpace{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;flex:1 0 100%;width:100%;min-width:100%;min-height:0;max-height:42vh;margin-top:8px;padding-top:8px;display:flex}.iHN4tq_groupSpaceHead{color:var(--dsw-alias-label-tertiary);flex:none;padding:0 8px 6px;font-size:11px;font-weight:600}.iHN4tq_groupSpaceHint{color:var(--dsw-alias-label-tertiary);flex:none;margin:0;padding:0 8px 8px;font-size:12px;line-height:18px}.iHN4tq_groupSpaceTree{flex-direction:column;flex:1;gap:4px;min-height:0;display:flex;overflow:auto}.iHN4tq_groupSpaceRoom{flex-direction:column;gap:2px;display:flex}.iHN4tq_groupSpaceTopics{border-left:1px solid var(--dsw-alias-border-l2);margin-left:12px;padding-left:8px}.iHN4tq_groupSpaceRowWrap{align-items:center;gap:2px;display:flex}.iHN4tq_groupSpaceRow{width:100%;min-width:0;color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:4px;align-items:center;gap:6px;padding:4px 8px;font-size:12px;display:flex}.iHN4tq_groupSpaceRow:hover,.iHN4tq_groupSpaceRowActive{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.iHN4tq_groupSpaceRowLabel{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.iHN4tq_groupSpaceMeta{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px}.iHN4tq_groupSpaceToggle{width:18px;height:18px;color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:4px;flex:none;padding:0;font-size:11px}.iHN4tq_groupSpaceToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.iHN4tq_groupSpaceMore{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:4px;margin:4px 8px 8px;padding:4px 8px;font-size:12px}.iHN4tq_groupSpaceMore:disabled{opacity:.5;cursor:default}.iHN4tq_groupSpaceGlyph{background:var(--dsw-alias-bg-layer-2);width:18px;height:18px;color:var(--dsw-alias-label-secondary);text-align:center;border-radius:4px;flex:none;font-size:11px;line-height:18px;overflow:hidden}.iHN4tq_groupSpaceGlyph img{object-fit:cover;width:18px;height:18px;display:block}.iHN4tq_streamMore{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:6px;align-self:center;margin:4px 0 8px;padding:4px 10px;font-size:12px}.iHN4tq_streamMore:disabled{opacity:.5;cursor:default}.iHN4tq_roomShell{flex-direction:column;flex:1;min-width:0;height:100%;min-height:0;display:flex}.iHN4tq_pageTabs{border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;align-items:center;gap:28px;padding:0 20px;display:flex}.iHN4tq_pageTab{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:12px 0;font-size:14px;line-height:22px;position:relative}.iHN4tq_pageTabOn{color:var(--dsw-static-deepseek-500);font-weight:600}.iHN4tq_pageTabOn:after{content:\"\";background:var(--dsw-static-deepseek-500);border-radius:200px;height:2px;position:absolute;bottom:0;left:0;right:0}.iHN4tq_pageBody{flex:1;min-width:0;min-height:0;display:flex}.iHN4tq_roomMain{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex}.iHN4tq_roomMainHead{flex:none;justify-content:flex-end;padding:6px 12px 0;display:flex}.iHN4tq_topicToggle{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:999px;align-items:center;gap:6px;padding:4px 8px;font-size:12px;font-weight:500;display:inline-flex}.iHN4tq_topicToggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.iHN4tq_topicToggleBadge{background:var(--dsw-static-deepseek-500);color:#fff;text-align:center;border-radius:999px;min-width:16px;height:16px;padding:0 5px;font-size:10px;font-weight:700;line-height:16px}.iHN4tq_roomStage{flex:1;min-width:0;min-height:0;display:flex}.iHN4tq_roomTimeline .iHN4tq_stream{flex:1;gap:0;min-width:0;min-height:0}.iHN4tq_roomTimeline .iHN4tq_stream .iHN4tq_streamMore{margin-bottom:8px}.iHN4tq_roomRowHighlight{outline:2px solid var(--dsw-static-deepseek-500);outline-offset:2px;border-radius:8px}.iHN4tq_convList{border-right:1px solid var(--dsw-alias-border-l2);flex-direction:column;flex:none;width:236px;min-width:180px;min-height:0;display:flex}.iHN4tq_convListHint{color:var(--dsw-alias-label-tertiary);flex:none;margin:0;padding:0 12px 8px;font-size:12px;line-height:18px}.iHN4tq_convListBody{flex-direction:column;flex:1;min-height:0;display:flex;overflow:auto}.iHN4tq_convRow{width:100%;min-width:0;color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;cursor:pointer;background:0 0;border:none;gap:8px;padding:8px 12px;display:flex}.iHN4tq_convRow:hover,.iHN4tq_convRowActive{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.iHN4tq_convGlyph{background:var(--dsw-alias-bg-layer-2);width:32px;height:32px;color:var(--dsw-alias-label-secondary);text-align:center;border-radius:50%;flex:none;font-size:13px;line-height:32px;overflow:hidden}.iHN4tq_convGlyph img{object-fit:cover;width:32px;height:32px;display:block}.iHN4tq_convRowBody{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.iHN4tq_convRowTop,.iHN4tq_convRowBottom{align-items:center;gap:6px;min-width:0;display:flex}.iHN4tq_convRowName{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;font-size:13px;font-weight:500;overflow:hidden}.iHN4tq_convRowTime{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px}.iHN4tq_convRowPreview{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;font-size:12px;overflow:hidden}.iHN4tq_convDot{background:var(--dsw-static-deepseek-500);border-radius:50%;flex:none;width:6px;height:6px}.iHN4tq_convBadge{background:var(--dsw-static-deepseek-500);color:#fff;text-align:center;border-radius:999px;flex:none;min-width:16px;height:16px;padding:0 5px;font-size:10px;font-weight:700;line-height:16px}.iHN4tq_convMore{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;text-align:left;background:0 0;border:none;margin:4px 12px 10px;padding:4px 0;font-size:12px}.iHN4tq_convMore:disabled{opacity:.5;cursor:default}.iHN4tq_topicDrawer{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex-direction:column;flex:none;width:340px;min-width:260px;min-height:0;display:flex}.iHN4tq_topicDrawerHead{border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;align-items:center;gap:6px;padding:8px 8px 6px;display:flex}.iHN4tq_topicDrawerTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;font-size:13px;font-weight:600;overflow:hidden}.iHN4tq_topicDrawerNav{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:2px 4px;font-size:12px}.iHN4tq_topicDrawerBody{flex-direction:column;flex:1;gap:6px;min-height:0;padding:8px;display:flex;overflow:auto}.iHN4tq_topicDrawerHint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:18px}.iHN4tq_topicCard{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:8px;flex-direction:column;gap:2px;padding:8px;display:flex}.iHN4tq_topicCardTitle{font-size:13px;font-weight:600}.iHN4tq_topicCardOrigin{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.iHN4tq_topicAnchorWrap{flex-direction:column;gap:4px;margin:0 8px 4px;display:flex}.iHN4tq_topicAnchorBar{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:8px;flex-direction:column;align-items:flex-start;gap:2px;margin:0;padding:8px;display:flex}.iHN4tq_topicAnchorExcerpt{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:2;word-break:break-word;-webkit-box-orient:vertical;font-size:12px;display:-webkit-box;overflow:hidden}.iHN4tq_topicDrawerAsk{border-top:1px solid var(--dsw-alias-border-l2);flex:none;gap:6px;padding:8px;display:flex}.iHN4tq_topicDrawerInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;color:var(--dsw-alias-label-primary);font:inherit;border-radius:6px;flex:1;padding:6px 8px;font-size:13px}.iHN4tq_topicDrawerSend{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;border-radius:6px;flex:none;padding:6px 8px;font-size:12px}.iHN4tq_topicDrawerSend:disabled,.iHN4tq_topicDrawerInput:disabled{opacity:.5;cursor:default}.iHN4tq_topicLensRow{display:flex}.iHN4tq_topicLensRowUser{justify-content:flex-end}.iHN4tq_topicLensRowAssistant{justify-content:flex-start}.iHN4tq_topicLensStack{flex-direction:column;gap:6px;max-width:90%;display:flex}.iHN4tq_topicLensBubble{white-space:pre-wrap;word-break:break-word;max-width:100%;padding:6px 8px;font-size:12px;line-height:18px}.iHN4tq_topicLensBubbleUser{background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:8px 2px 8px 8px}.iHN4tq_topicLensBubbleAssistant{background:var(--dsw-alias-bg-base);border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);border-radius:2px 8px 8px}.iHN4tq_yzjDock{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;flex:none;width:100%;margin-top:4px;padding-top:8px;display:flex}.iHN4tq_yzjDockNarrow{flex-direction:column;align-items:center;gap:2px;margin-top:4px;padding-top:8px;display:flex}.iHN4tq_yzjDockEntries{flex-direction:row;align-items:center;gap:4px;padding:0 8px;display:flex}.iHN4tq_yzjDockEntry{min-width:0;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;flex:1;align-items:center;gap:8px;padding:6px 10px;font-size:13px;line-height:18px;display:flex}.iHN4tq_yzjDockEntry:hover,.iHN4tq_yzjDockEntryActive,.iHN4tq_yzjDockEntryActive:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.iHN4tq_yzjDockMark{text-align:center;width:16px;color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:1}.iHN4tq_yzjDockNarrow .iHN4tq_yzjDockEntries{align-items:center;padding:0}.iHN4tq_yzjDockNarrow .iHN4tq_yzjDockEntry{flex:none;justify-content:center;width:32px;padding:6px}.iHN4tq_yzjDockLabel{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.iHN4tq_yzjDockRobot{flex:none;align-items:center;padding:0 4px;display:flex}.iHN4tq_yzjDockRobotDot{background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:6px;height:6px}.iHN4tq_yzjDockRobotDotOk{background:var(--dsw-alias-state-success-primary)}.iHN4tq_yzjDockRobotDotWarn{background:var(--dsw-alias-state-warn-primary)}.iHN4tq_yzjDockHint{color:var(--dsw-alias-label-tertiary);margin:0;padding:0 12px 8px;font-size:12px;line-height:18px}";
		...
		var home_module_css_default = {
			"pageTabOn": "iHN4tq_pageTabOn",
			"roomMainHead": "iHN4tq_roomMainHead",
			"convList": "iHN4tq_convList",
			"hint": "iHN4tq_hint",
			"candidate": "iHN4tq_candidate",
			"pageBody": "iHN4tq_pageBody",
			"topicDrawerBody": "iHN4tq_topicDrawerBody",
			"groupSpaceMeta": "iHN4tq_groupSpaceMeta",
			"roomReplyBar": "iHN4tq_roomReplyBar",
			"yzjDockEntryActive": "iHN4tq_yzjDockEntryActive",
			"roomReplyCancel": "iHN4tq_roomReplyCancel",
			"roomReplyText": "iHN4tq_roomReplyText",
			"artifactNote": "iHN4tq_artifactNote",
			"roomRowSelf": "iHN4tq_roomRowSelf",
			"artifactMeta": "iHN4tq_artifactMeta",
			"roomMain": "iHN4tq_roomMain",
			"tag": "iHN4tq_tag",
			"topicDockSummary": "iHN4tq_topicDockSummary",
			"roomRow": "iHN4tq_roomRow",
			"groupSpaceRowLabel": "iHN4tq_groupSpaceRowLabel",
			"topicDrawerSend": "iHN4tq_topicDrawerSend",
			"roomComposerTools": "iHN4tq_roomComposerTools",
			"replyChip": "iHN4tq_replyChip",
			"groupSpaceHint": "iHN4tq_groupSpaceHint",
			"roomBubbleOther": "iHN4tq_roomBubbleOther",
			"chromeBtn": "iHN4tq_chromeBtn",
			"row": "iHN4tq_row",
			"convDot": "iHN4tq_convDot",
			"roomRowHighlight": "iHN4tq_roomRowHighlight",
			"groupSpaceMore": "iHN4tq_groupSpaceMore",
			"convRowBody": "iHN4tq_convRowBody",
			"topicCardTitle": "iHN4tq_topicCardTitle",
			"rowSelf": "iHN4tq_rowSelf",
			"roomComposerSeat": "iHN4tq_roomComposerSeat",
			"roomBubbleSelf": "iHN4tq_roomBubbleSelf",
			"topicAnchorWrap": "iHN4tq_topicAnchorWrap",
			"roomComposerHost": "iHN4tq_roomComposerHost",
			"convRowName": "iHN4tq_convRowName",
			"topicLensRowUser": "iHN4tq_topicLensRowUser",
			"artifactCard": "iHN4tq_artifactCard",
			"roomRowOther": "iHN4tq_roomRowOther",
			"groupSpaceTree": "iHN4tq_groupSpaceTree",
			"yzjDockNarrow": "iHN4tq_yzjDockNarrow",
			"yzjDockRobot": "iHN4tq_yzjDockRobot",
			"chromePrimary": "iHN4tq_chromePrimary",
			"roomToolBtn": "iHN4tq_roomToolBtn",
			"convRowActive": "iHN4tq_convRowActive",
			"topicDrawerTitle": "iHN4tq_topicDrawerTitle",
			"yzjDock": "iHN4tq_yzjDock",
			"topicChip": "iHN4tq_topicChip",
			"groupSpaceRoom": "iHN4tq_groupSpaceRoom",
			"convBadge": "iHN4tq_convBadge",
			"yzjDockEntry": "iHN4tq_yzjDockEntry",
			"unbound": "iHN4tq_unbound",
			"streamMore": "iHN4tq_streamMore",
			"topicDockLabel": "iHN4tq_topicDockLabel",
			"pick": "iHN4tq_pick",
			"roomTimeline": "iHN4tq_roomTimeline",
			"roomRowMerged": "iHN4tq_roomRowMerged",
			"topicToggleBadge": "iHN4tq_topicToggleBadge",
			"topicLensBubbleAssistant": "iHN4tq_topicLensBubbleAssistant",
			"roomStack": "iHN4tq_roomStack",
			"convRowPreview": "iHN4tq_convRowPreview",
			"groupSpaceToggle": "iHN4tq_groupSpaceToggle",
			"topicDrawer": "iHN4tq_topicDrawer",
			"yzjDockRobotDotOk": "iHN4tq_yzjDockRobotDotOk",
			"topicListLabel": "iHN4tq_topicListLabel",
			"groupSpaceTopics": "iHN4tq_groupSpaceTopics",
			"yzjDockHint": "iHN4tq_yzjDockHint",
			"roomShell": "iHN4tq_roomShell",
			"artifactName": "iHN4tq_artifactName",
			"roomComposer": "iHN4tq_roomComposer",
			"roomEmojiPanel": "iHN4tq_roomEmojiPanel",
			"convRowTop": "iHN4tq_convRowTop",
			"agent": "iHN4tq_agent",
			"actions": "iHN4tq_actions",
			"streamContent": "iHN4tq_streamContent",
			"topicCard": "iHN4tq_topicCard",
			"topicLensRow": "iHN4tq_topicLensRow",
			"topicToggle": "iHN4tq_topicToggle",
			"roomComposerCard": "iHN4tq_roomComposerCard",
			"roomSendCircle": "iHN4tq_roomSendCircle",
			"artifactType": "iHN4tq_artifactType",
			"groupSpaceRowWrap": "iHN4tq_groupSpaceRowWrap",
			"yzjDockLabel": "iHN4tq_yzjDockLabel",
			"groupSpaceGlyph": "iHN4tq_groupSpaceGlyph",
			"convGlyph": "iHN4tq_convGlyph",
			"roomClampToggle": "iHN4tq_roomClampToggle",
			"yzjDockMark": "iHN4tq_yzjDockMark",
			"pageTab": "iHN4tq_pageTab",
			"convListHint": "iHN4tq_convListHint",
			"yzjDockRobotDotWarn": "iHN4tq_yzjDockRobotDotWarn",
			"meta": "iHN4tq_meta",
			"convListBody": "iHN4tq_convListBody",
			"convMore": "iHN4tq_convMore",
			"topicLensRowAssistant": "iHN4tq_topicLensRowAssistant",
			"yzjDockRobotDot": "iHN4tq_yzjDockRobotDot",
			"topicDrawerNav": "iHN4tq_topicDrawerNav",
			"roomStage": "iHN4tq_roomStage",
			"topicDrawerHint": "iHN4tq_topicDrawerHint",
			"daySep": "iHN4tq_daySep",
			"groupSpaceRowActive": "iHN4tq_groupSpaceRowActive",
			"topicDrawerInput": "iHN4tq_topicDrawerInput",
			"topicCardOrigin": "iHN4tq_topicCardOrigin",
			"chrome": "iHN4tq_chrome",
			"convRow": "iHN4tq_convRow",
			"yzjDockEntries": "iHN4tq_yzjDockEntries",
			"topicLensStack": "iHN4tq_topicLensStack",
			"kindPill": "iHN4tq_kindPill",
			"topicAnchorExcerpt": "iHN4tq_topicAnchorExcerpt",
			"topicDrawerAsk": "iHN4tq_topicDrawerAsk",
			"roomClamp": "iHN4tq_roomClamp",
			"roomBubbleAssistant": "iHN4tq_roomBubbleAssistant",
			"roomComposerBar": "iHN4tq_roomComposerBar",
			"chromeQuiet": "iHN4tq_chromeQuiet",
			"roomMeta": "iHN4tq_roomMeta",
			"modalMask": "iHN4tq_modalMask",
			"stream": "iHN4tq_stream",
			"topicList": "iHN4tq_topicList",
			"roomRowActions": "iHN4tq_roomRowActions",
			"groupSpaceHead": "iHN4tq_groupSpaceHead",
			"im": "iHN4tq_im",
			"topicDrawerHead": "iHN4tq_topicDrawerHead",
			"modal": "iHN4tq_modal",
			"groupSpaceSection": "iHN4tq_groupSpaceSection",
			"bubble": "iHN4tq_bubble",
			"stack": "iHN4tq_stack",
			"convRowTime": "iHN4tq_convRowTime",
			"roomComposerInput": "iHN4tq_roomComposerInput",
			"roomBubble": "iHN4tq_roomBubble",
			"groupSpace": "iHN4tq_groupSpace",
			"topicLensBubbleUser": "iHN4tq_topicLensBubbleUser",
			"pageTabs": "iHN4tq_pageTabs",
			"handBtn": "iHN4tq_handBtn",
			"convRowBottom": "iHN4tq_convRowBottom",
			"rowOther": "iHN4tq_rowOther",
			"chromeLink": "iHN4tq_chromeLink",
			"pending": "iHN4tq_pending",
			"imSelf": "iHN4tq_imSelf",
			"roomAction": "iHN4tq_roomAction",
			"groupSpaceRow": "iHN4tq_groupSpaceRow",
			"topicLensBubble": "iHN4tq_topicLensBubble",
			"roomEmojiBtn": "iHN4tq_roomEmojiBtn",
			"topicDock": "iHN4tq_topicDock",
			"roomAvatarSlot": "iHN4tq_roomAvatarSlot",
			"topicDockBtn": "iHN4tq_topicDockBtn",
			"topicAnchorBar": "iHN4tq_topicAnchorBar",
			"failed": "iHN4tq_failed"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/workspace/packages/ui-yzj/src/client/login-banner.module.css.mjs
		const css$7 = ".wLxqFq_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;flex-direction:column;gap:8px;margin:8px 12px;padding:10px 12px;display:flex}.wLxqFq_compact{gap:6px;margin:8px 10px;padding:8px 10px}.wLxqFq_title{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:600;line-height:18px}.wLxqFq_body,.wLxqFq_hint,.wLxqFq_status{color:var(--dsw-alias-label-secondary);margin:0;font-size:12px;line-height:18px}.wLxqFq_hint{color:var(--dsw-alias-label-tertiary);word-break:break-word}.wLxqFq_status{flex:none;padding:4px 0 10px}.wLxqFq_actions{flex-wrap:wrap;gap:6px;display:flex}.wLxqFq_primary,.wLxqFq_secondary{cursor:pointer;border-radius:8px;padding:8px 12px;font-family:inherit;font-size:12.5px;line-height:1}.wLxqFq_primary{background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600);border:none;font-weight:600}.wLxqFq_primary:hover:not(:disabled){filter:brightness(.97)}.wLxqFq_primary:disabled{cursor:progress;opacity:.7}.wLxqFq_secondary{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.wLxqFq_secondary:hover{color:var(--dsw-alias-label-primary)}";
		...
		var login_banner_module_css_default = {
			"compact": "wLxqFq_compact",
			"status": "wLxqFq_status",
			"hint": "wLxqFq_hint",
			"title": "wLxqFq_title",
			"primary": "wLxqFq_primary",
			"card": "wLxqFq_card",
			"actions": "wLxqFq_actions",
			"secondary": "wLxqFq_secondary",
			"body": "wLxqFq_body"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/workspace/packages/ui-yzj/src/client/panel.module.css.mjs
		const css$6 = ".lIVaIG_toggle{width:100%;color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease), color .12s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:8px;justify-content:center;align-items:center;gap:6px;padding:6px 10px;display:flex}.lIVaIG_toggle:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.lIVaIG_toggleActive{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-static-deepseek-500)}.lIVaIG_toggleLabel{white-space:nowrap;font-size:12px;font-weight:500}.lIVaIG_unreadBadge{background:var(--dsw-static-red-500);color:#fff;text-align:center;border-radius:999px;flex:none;min-width:16px;height:16px;padding:0 4px;font-size:10px;line-height:16px;position:relative}.lIVaIG_panel{z-index:100;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);width:min(880px,96vw);height:min(700px,94vh);color:var(--dsw-alias-label-primary);border-radius:14px;flex-direction:column;margin:auto;font-size:14px;line-height:20px;display:flex;position:fixed;inset:0;overflow:hidden;box-shadow:0 16px 48px #0000002e}.lIVaIG_panelEmbedded{z-index:0;width:100%;height:100%;min-height:0;box-shadow:none;border:none;border-radius:0;margin:0;position:relative;inset:auto}.lIVaIG_header{flex:none;align-items:center;gap:8px;padding:10px 12px;display:flex}.lIVaIG_brand{color:var(--dsw-static-deepseek-500);flex:none;align-items:center;display:inline-flex}.lIVaIG_title{flex:none;font-size:14px;font-weight:600}.lIVaIG_headerSpacer{flex:1}.lIVaIG_tabs{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;gap:2px;padding:2px 12px 8px;display:flex;overflow:hidden}.lIVaIG_tab{color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease), color .12s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:8px;flex:1;justify-content:center;align-items:center;gap:4px;padding:5px 8px;font-size:12px;display:inline-flex}.lIVaIG_tab:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.lIVaIG_tabActive{background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600);font-weight:600}.lIVaIG_tabActive:hover{background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600)}.lIVaIG_iconButton{width:26px;height:26px;color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease), color .12s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:7px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.lIVaIG_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.lIVaIG_iconButton:disabled{opacity:.5;cursor:default}.lIVaIG_headerButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease);border-radius:8px;flex:none;padding:5px 12px;font-size:12px}.lIVaIG_headerButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.lIVaIG_headerButton:disabled{opacity:.5;cursor:default}.lIVaIG_body{flex-direction:column;flex:1;min-height:0;display:flex;overflow:hidden}.lIVaIG_twoPane{flex:1;min-height:0;display:flex}.lIVaIG_paneLeft{border-right:1px solid var(--dsw-alias-border-l1);flex-direction:column;flex:none;width:250px;min-height:0;display:flex}.lIVaIG_paneRight{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex}.lIVaIG_paneList{flex-direction:column;flex:1;gap:3px;min-height:0;padding:8px;display:flex;overflow:auto}.lIVaIG_paneEmpty{min-height:0;color:var(--dsw-alias-label-tertiary);flex-direction:column;flex:1;justify-content:center;align-items:center;gap:8px;font-size:13px;display:flex}.lIVaIG_paneHead{flex:none;align-items:center;gap:8px;padding:4px 10px 8px;display:flex}.lIVaIG_paneTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;font-weight:600;overflow:hidden}.lIVaIG_itemActive{background:var(--dsw-static-deepseek-100);box-shadow:inset 3px 0 0 var(--dsw-static-deepseek-500)}.lIVaIG_itemActive:hover{background:var(--dsw-static-deepseek-100)}.lIVaIG_itemActive .lIVaIG_itemTitleText{color:var(--dsw-static-deepseek-600);font-weight:700}.lIVaIG_readAllRow{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;justify-content:space-between;align-items:center;gap:8px;padding:6px 12px;display:flex}.lIVaIG_readAllHint{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:16px}.lIVaIG_readAll{border:1px solid var(--dsw-static-deepseek-500);color:var(--dsw-static-deepseek-500);cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease), color .12s var(--ds-ease-in-out,ease);background:0 0;border-radius:999px;flex:none;padding:3px 12px;font-size:12px;line-height:18px}.lIVaIG_readAll:hover:not(:disabled){background:var(--dsw-static-deepseek-100)}.lIVaIG_readAll:disabled{opacity:.45;cursor:default}.lIVaIG_error{border-bottom:1px solid var(--dsw-static-red-500);background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-static-red-400);flex:none;align-items:center;gap:8px;padding:7px 12px;font-size:12px;display:flex}.lIVaIG_errorText{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.lIVaIG_errorDismiss{width:20px;height:20px;color:inherit;cursor:pointer;background:0 0;border:none;border-radius:5px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.lIVaIG_errorDismiss:hover{background:var(--dsw-alias-interactive-bg-hover)}.lIVaIG_loading{color:var(--dsw-alias-label-tertiary);flex:none;padding:6px 12px;font-size:12px}.lIVaIG_list{flex-direction:column;flex:1;gap:3px;padding:8px;display:flex;overflow:auto}.lIVaIG_item{color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;min-width:0;transition:background-color .12s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:10px;flex-direction:column;gap:3px;padding:8px 10px;font-size:14px;display:flex}.lIVaIG_item:hover{background:var(--dsw-alias-interactive-bg-hover)}.lIVaIG_itemTitle{align-items:center;gap:10px;min-width:0;font-weight:500;display:flex}.lIVaIG_itemTitleText{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.lIVaIG_itemSub{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;padding-left:42px;font-size:12px;line-height:16px;overflow:hidden}.lIVaIG_docGlyph,.lIVaIG_groupGlyph,.lIVaIG_userGlyph{background:var(--dsw-static-deepseek-100);width:32px;height:32px;color:var(--dsw-static-deepseek-600);border-radius:8px;flex:none;justify-content:center;align-items:center;font-size:14px;font-weight:600;display:inline-flex}.lIVaIG_badge{background:var(--dsw-static-red-500);color:#fff;border-radius:999px;flex:none;padding:0 6px;font-size:11px;line-height:16px}.lIVaIG_itemAnchored{outline:2px solid var(--dsw-static-deepseek-500);outline-offset:-1px;background:var(--dsw-static-deepseek-100)}.lIVaIG_msgItem{background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l1);padding-left:18px;position:relative}.lIVaIG_msgRow{border-radius:10px;align-items:flex-start;gap:8px;min-width:0;padding:4px 10px 4px 18px;display:flex;position:relative}.lIVaIG_msgRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.lIVaIG_msgRowSystem{justify-content:center;padding-left:10px}.lIVaIG_msgAvatar{object-fit:cover;background:var(--dsw-alias-bg-layer-2);border-radius:50%;flex:none;width:28px;height:28px;margin-top:2px}.lIVaIG_msgAvatarFallback{background:var(--dsw-static-deepseek-100);width:28px;height:28px;color:var(--dsw-static-deepseek-600);border-radius:50%;flex:none;justify-content:center;align-items:center;margin-top:2px;font-size:12px;font-weight:600;display:inline-flex}.lIVaIG_msgStack{flex-direction:column;flex:1;align-items:flex-start;min-width:0;display:flex}.lIVaIG_msgMetaLine{align-items:baseline;gap:8px;min-width:0;margin-top:1px;display:flex}.lIVaIG_msgTime{color:var(--dsw-alias-label-caption);font-variant-numeric:tabular-nums;flex:none;font-size:11px;line-height:14px}.lIVaIG_msgContent{min-width:0;margin-top:2px}.lIVaIG_anchorTag{background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600);border-radius:999px;flex:none;padding:0 6px;font-size:10px;line-height:16px}.lIVaIG_anchorHint{border:1px solid var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600);border-radius:8px;flex:none;margin:0 10px;padding:4px 10px;font-size:11px;line-height:16px}.lIVaIG_groupChips{scrollbar-width:none;flex:none;gap:6px;padding:6px 10px 2px;display:flex;overflow-x:auto}.lIVaIG_groupChips::-webkit-scrollbar{display:none}.lIVaIG_groupChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);cursor:pointer;transition:border-color .12s var(--ds-ease-in-out,ease), background-color .12s var(--ds-ease-in-out,ease), color .12s var(--ds-ease-in-out,ease);border-radius:999px;flex:none;align-items:center;gap:5px;padding:3px 10px;font-size:12px;line-height:18px;display:inline-flex}.lIVaIG_groupChip:hover{border-color:var(--dsw-static-deepseek-500);color:var(--dsw-alias-label-primary)}.lIVaIG_groupChipActive{border-color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600);font-weight:600}.lIVaIG_chipBadge{background:var(--dsw-static-red-500);color:#fff;border-radius:999px;padding:0 5px;font-size:10px;line-height:14px}.lIVaIG_msgReply{color:var(--dsw-static-deepseek-500);cursor:pointer;opacity:0;transition:opacity .12s var(--ds-ease-in-out,ease), background-color .12s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:6px;margin-top:2px;padding:2px 8px;font-size:11px;line-height:16px}.lIVaIG_msgRow:hover .lIVaIG_msgReply{opacity:1}.lIVaIG_msgReply:hover{background:var(--dsw-alias-interactive-bg-hover)}.lIVaIG_dayDivider{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-tertiary);border-radius:999px;margin:6px auto 2px;padding:1px 10px;font-size:11px;line-height:18px;display:table}.lIVaIG_groupHead{align-items:center;gap:8px;padding:2px 10px 8px;display:flex}.lIVaIG_groupHeadName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;font-weight:600;overflow:hidden}.lIVaIG_msgBody{color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;min-width:0;font-size:13px;line-height:18px}.lIVaIG_chatHeader{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);flex:none;align-items:center;gap:4px;padding:2px 4px 0;display:flex}.lIVaIG_panelBanner{background:var(--dsw-static-deepseek-100);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:6px 8px 4px;padding:8px 10px;font-size:12px;line-height:18px}.lIVaIG_chatHeader .lIVaIG_groupHead{padding:2px 6px 6px}.lIVaIG_back{color:var(--dsw-static-deepseek-500);text-align:left;cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:2px;padding:5px 8px;font-size:12px;display:inline-flex}.lIVaIG_back:hover{background:var(--dsw-static-deepseek-100)}.lIVaIG_more{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-static-deepseek-500);cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease);border-radius:999px;flex:none;margin:6px auto 2px;padding:5px 14px;font-size:12px}.lIVaIG_more:hover:not(:disabled){background:var(--dsw-static-deepseek-100)}.lIVaIG_more:disabled{opacity:.5;cursor:default}.lIVaIG_empty{color:var(--dsw-alias-label-tertiary);text-align:center;flex-direction:column;align-items:center;gap:10px;padding:44px 0;font-size:12px;display:flex}.lIVaIG_searchRow{flex:none;gap:6px;padding:10px 10px 6px;display:flex}.lIVaIG_searchInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);transition:border-color .12s var(--ds-ease-in-out,ease), background-color .12s var(--ds-ease-in-out,ease);border-radius:8px;outline:none;flex:1;padding:6px 10px;font-size:13px}.lIVaIG_searchInput:focus{border-color:var(--dsw-static-deepseek-500);background:var(--dsw-alias-bg-base)}.lIVaIG_meCard{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:12px;flex:none;align-items:center;gap:12px;margin:6px 10px 8px;padding:12px;display:flex}.lIVaIG_meAvatar{object-fit:cover;border-radius:50%;flex:none;width:44px;height:44px}.lIVaIG_meAvatarFallback{background:var(--dsw-static-deepseek-100);width:44px;height:44px;color:var(--dsw-static-deepseek-600);border-radius:50%;flex:none;justify-content:center;align-items:center;font-size:18px;font-weight:600;display:inline-flex}.lIVaIG_meInfo{min-width:0}.lIVaIG_meName{font-size:15px;font-weight:600}.lIVaIG_meSub{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:12px;line-height:16px}.lIVaIG_floatWrap{z-index:90;position:fixed;bottom:26px;right:26px}.lIVaIG_floatBall{background:var(--dsw-alias-button-info-fill);width:52px;height:52px;color:var(--dsw-alias-label-primary-foreground);cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease), transform .12s var(--ds-ease-in-out,ease);border:none;border-radius:50%;justify-content:center;align-items:center;display:flex;position:relative;box-shadow:0 4px 14px #2e6ff259}.lIVaIG_floatBall:hover{background:var(--dsw-alias-button-info-hover);transform:scale(1.04)}.lIVaIG_floatBallActive{box-shadow:0 0 0 2px var(--dsw-alias-bg-base), 0 0 0 4px var(--dsw-static-deepseek-500), 0 4px 14px #2e6ff259}.lIVaIG_floatBallBadge{border:2px solid var(--dsw-alias-bg-base);background:var(--dsw-static-red-500);color:#fff;border-radius:999px;justify-content:center;align-items:center;min-width:20px;height:20px;padding:0 5px;font-size:11px;font-weight:700;line-height:16px;display:flex;position:absolute;top:-4px;right:-4px}.lIVaIG_floatDock{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);opacity:0;visibility:hidden;transition:opacity .12s var(--ds-ease-in-out,ease), transform .12s var(--ds-ease-in-out,ease), visibility .12s;border-radius:12px;flex-direction:column;gap:2px;padding:6px;display:flex;position:absolute;bottom:62px;right:0;transform:translateY(6px);box-shadow:0 12px 32px #00000024}.lIVaIG_floatDockOpen{opacity:1;visibility:visible;transform:none}.lIVaIG_floatDockItem{width:92px;color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease), color .12s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:8px;align-items:center;gap:8px;padding:6px 10px;display:flex;position:relative}.lIVaIG_floatDockItem:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.lIVaIG_floatDockLabel{white-space:nowrap;font-size:12px;line-height:16px}.lIVaIG_floatDockBadge{border:1px solid var(--dsw-alias-bg-layer-1);background:var(--dsw-static-red-500);color:#fff;border-radius:999px;justify-content:center;align-items:center;min-width:16px;height:16px;padding:0 4px;font-size:10px;font-weight:700;line-height:14px;display:flex;position:absolute;top:2px;left:26px}.lIVaIG_panelToast{background:var(--dsw-static-neutral-bluish-850);color:var(--dsw-alias-label-primary-foreground);text-align:center;border-radius:999px;margin:2px 4px 6px;padding:8px 12px;font-size:11px;line-height:16px}.lIVaIG_avatar{object-fit:cover;background:var(--dsw-alias-bg-layer-2);border-radius:8px;flex:none;width:32px;height:32px}.lIVaIG_itemTime{color:var(--dsw-alias-label-caption);font-variant-numeric:tabular-nums;flex:none;font-size:11px;line-height:14px}.lIVaIG_msgSender{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:none;min-width:0;font-size:12px;font-weight:600;line-height:16px;overflow:hidden}.lIVaIG_msgQuote{color:var(--dsw-alias-label-tertiary);border-left:2px solid var(--dsw-alias-border-l3);background:var(--dsw-alias-bg-layer-2);text-overflow:ellipsis;white-space:nowrap;border-radius:6px;min-width:0;margin:0 0 4px;padding:4px 8px;font-size:12px;line-height:16px;display:block;overflow:hidden}.lIVaIG_msgImage{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);cursor:zoom-in;border-radius:8px;max-width:100%;max-height:220px;margin-top:4px;display:block}.lIVaIG_msgBold{font-weight:600}.lIVaIG_msgImageSkeleton,.lIVaIG_msgImageFail{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-tertiary);border-radius:6px;margin-top:4px;padding:6px 10px;font-size:12px;line-height:16px;display:inline-block}.lIVaIG_msgImageFail{color:var(--dsw-static-red-400)}.lIVaIG_msgSystem{color:var(--dsw-alias-label-tertiary);text-align:center;font-size:12px;line-height:18px}.lIVaIG_msgFile{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);cursor:pointer;min-width:0;transition:border-color .12s var(--ds-ease-in-out,ease), background-color .12s var(--ds-ease-in-out,ease);border-radius:8px;align-items:center;gap:10px;margin-top:2px;padding:8px 10px;text-decoration:none;display:flex}.lIVaIG_msgFileGroup{align-items:stretch;gap:6px;min-width:0;display:flex}.lIVaIG_msgFile:hover:not(:disabled){border-color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-100)}.lIVaIG_msgFile:disabled{opacity:.5;cursor:default}.lIVaIG_msgFileDownload{border:1px dashed var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;transition:border-color .12s var(--ds-ease-in-out,ease), color .12s var(--ds-ease-in-out,ease);background:0 0;border-radius:8px;flex:none;align-self:center;padding:4px 8px;font-size:11px;line-height:14px}.lIVaIG_msgFileDownload:hover{border-color:var(--dsw-static-deepseek-500);color:var(--dsw-static-deepseek-500)}.lIVaIG_msgFileIcon{flex:none;font-size:20px;line-height:20px}.lIVaIG_msgFileMeta{flex-direction:column;gap:2px;min-width:0;display:flex}.lIVaIG_msgFileName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;line-height:16px;overflow:hidden}.lIVaIG_msgFileSize{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:14px}.lIVaIG_linkCard{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);min-width:0;transition:border-color .12s var(--ds-ease-in-out,ease);border-radius:8px;gap:10px;margin-top:2px;padding:8px 10px;text-decoration:none;display:flex}.lIVaIG_linkCard:hover{border-color:var(--dsw-static-deepseek-500)}.lIVaIG_linkCardThumb{object-fit:cover;background:var(--dsw-alias-bg-layer-2);border-radius:6px;flex:none;width:56px;height:56px}.lIVaIG_linkCardBody{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.lIVaIG_linkCardTitle{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:16px;overflow:hidden}.lIVaIG_linkCardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:2;-webkit-box-orient:vertical;font-size:12px;line-height:16px;display:-webkit-box;overflow:hidden}.lIVaIG_linkCardAction{color:var(--dsw-static-deepseek-500);font-size:11px;line-height:14px}.lIVaIG_lightbox{z-index:200;cursor:zoom-out;background:#000000b8;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.lIVaIG_lightboxImg{border-radius:8px;max-width:90vw;max-height:90vh;box-shadow:0 24px 64px #00000080}.lIVaIG_lightboxPdf{background:#fff;border:none;border-radius:8px;width:min(720px,92vw);height:min(90vh,900px);box-shadow:0 24px 64px #00000080}.lIVaIG_composer{border-top:1px solid var(--dsw-alias-border-l1);flex-direction:column;flex:none;gap:6px;padding:8px 10px;display:flex;position:relative}.lIVaIG_composerRow{align-items:flex-end;gap:6px;display:flex;position:relative}.lIVaIG_atMenu{z-index:20;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:10px;flex-direction:column;gap:1px;min-width:180px;max-width:260px;padding:4px;display:flex;position:absolute;bottom:calc(100% + 6px);left:0;box-shadow:0 8px 24px #0003}.lIVaIG_atHint{color:var(--dsw-alias-label-tertiary);padding:5px 8px;font-size:11px;line-height:15px}.lIVaIG_atItem{color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:7px;align-items:center;gap:8px;padding:7px 8px;font-size:12.5px;line-height:1;display:flex}.lIVaIG_atItem:hover{background:var(--dsw-alias-interactive-bg-hover)}.lIVaIG_atGlyph{background:var(--dsw-static-deepseek-100);width:22px;height:22px;color:var(--dsw-static-deepseek-600);border-radius:50%;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.lIVaIG_composerInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;color:var(--dsw-alias-label-primary);resize:none;max-height:120px;transition:border-color .12s var(--ds-ease-in-out,ease);border-radius:10px;outline:none;flex:1;padding:7px 10px;font-family:inherit;font-size:13px;line-height:18px;overflow-y:auto}.lIVaIG_composerInput:focus{border-color:var(--dsw-static-deepseek-500)}.lIVaIG_composerInput::placeholder{color:var(--dsw-alias-label-tertiary)}.lIVaIG_composerInput:disabled{opacity:.6}.lIVaIG_composerSend{background:var(--dsw-static-deepseek-500);color:#fff;cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease), opacity .12s var(--ds-ease-in-out,ease);border:none;border-radius:10px;flex:none;padding:7px 14px;font-size:13px;font-weight:600}.lIVaIG_composerSend:hover:not(:disabled){background:var(--dsw-static-deepseek-600)}.lIVaIG_composerSend:disabled{opacity:.45;cursor:default}.lIVaIG_composerToolbar{align-items:center;gap:2px;display:flex}.lIVaIG_toolButton{cursor:pointer;width:26px;height:26px;transition:background-color .12s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:6px;justify-content:center;align-items:center;font-size:15px;line-height:15px;display:inline-flex}.lIVaIG_toolButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.lIVaIG_toolButton:disabled{opacity:.4;cursor:default}.lIVaIG_toolStatus{color:var(--dsw-alias-label-tertiary);margin-left:6px;font-size:11px}.lIVaIG_replyBar{border-left:2px solid var(--dsw-static-deepseek-500);background:var(--dsw-alias-bg-layer-1);border-radius:6px;align-items:center;gap:8px;padding:5px 8px;font-size:12px;display:flex}.lIVaIG_replyText{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-secondary);flex:1;overflow:hidden}.lIVaIG_replyCancel{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:4px;flex:none;padding:2px 4px;font-size:11px;line-height:14px}.lIVaIG_replyCancel:hover{background:var(--dsw-alias-interactive-bg-hover)}.lIVaIG_emojiPanel{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);z-index:30;border-radius:12px;grid-template-columns:repeat(8,1fr);gap:2px;padding:8px;display:grid;position:absolute;bottom:calc(100% - 4px);left:10px;box-shadow:0 12px 32px #00000029}.lIVaIG_emojiCell{cursor:pointer;background:0 0;border:none;border-radius:6px;justify-content:center;align-items:center;width:30px;height:30px;font-size:17px;display:inline-flex}.lIVaIG_emojiCell:hover{background:var(--dsw-alias-interactive-bg-hover)}.lIVaIG_calHead{flex:none;justify-content:space-between;align-items:center;padding:8px 10px 4px;display:flex}.lIVaIG_calTitle{font-size:13px;font-weight:600}.lIVaIG_calNav{width:24px;height:24px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;font-size:16px;line-height:16px}.lIVaIG_calNav:hover{background:var(--dsw-alias-interactive-bg-hover)}.lIVaIG_calToday{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);cursor:pointer;border-radius:999px;margin-left:6px;padding:4px 9px;font-size:11px;line-height:1;transition:border-color .15s,color .15s,background .15s}.lIVaIG_calToday:hover{border-color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600)}.lIVaIG_crumbs{flex-wrap:wrap;align-items:center;gap:2px;min-width:0;display:flex}.lIVaIG_crumbLink{color:var(--dsw-static-deepseek-500);cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;max-width:160px;padding:2px 3px;font-size:13px;line-height:18px;overflow:hidden}.lIVaIG_crumbLink:hover{text-decoration:underline}.lIVaIG_crumbItem{align-items:center;min-width:0;display:inline-flex}.lIVaIG_crumbSep{color:var(--dsw-alias-label-caption);padding:0 1px;font-size:12px}.lIVaIG_crumbCurrent{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;max-width:200px;padding:2px 3px;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}.lIVaIG_docRowWrap{align-items:stretch;gap:4px;min-width:0;display:flex}.lIVaIG_docRowWrap .lIVaIG_item{flex:1;min-width:0}.lIVaIG_drill{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:30px;color:var(--dsw-alias-label-tertiary);cursor:pointer;border-radius:9px;flex-shrink:0;justify-content:center;align-self:center;align-items:center;height:30px;transition:border-color .15s,color .15s,background .15s;display:inline-flex}.lIVaIG_drill:hover{border-color:var(--dsw-static-deepseek-500);color:var(--dsw-static-deepseek-600);background:var(--dsw-static-deepseek-100)}.lIVaIG_calGrid{grid-template-columns:repeat(7,1fr);gap:2px;padding:4px 10px 10px;display:grid}.lIVaIG_calDow{text-align:center;color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:20px}.lIVaIG_calBlank{height:30px}.lIVaIG_calCell{height:30px;color:var(--dsw-alias-label-primary);cursor:pointer;transition:background-color .12s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:8px;justify-content:center;align-items:center;font-size:12px;display:flex;position:relative}.lIVaIG_calCell:hover{background:var(--dsw-alias-interactive-bg-hover)}.lIVaIG_calCellToday{box-shadow:inset 0 0 0 1px var(--dsw-static-deepseek-500)}.lIVaIG_calCellSelected{background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600);font-weight:600}.lIVaIG_calCellHas{color:var(--dsw-static-deepseek-500);font-weight:600}.lIVaIG_calDayNum{line-height:18px}.lIVaIG_calDot{background:var(--dsw-static-deepseek-500);border-radius:50%;width:4px;height:4px;position:absolute;bottom:2px;left:50%;transform:translate(-50%)}.lIVaIG_eventTime{color:var(--dsw-static-deepseek-500);font-variant-numeric:tabular-nums;font-size:11px;line-height:14px}.lIVaIG_eventDetail{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;flex-direction:column;gap:6px;margin-top:4px;padding:10px 12px;display:flex}.lIVaIG_eventDetailTitle{font-size:14px;font-weight:600;line-height:20px}.lIVaIG_eventDetailRow{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}.lIVaIG_eventDetailContent{border-top:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;margin-top:4px;padding-top:8px;font-size:13px;line-height:20px}.lIVaIG_docMeta{color:var(--dsw-alias-label-tertiary);flex:none;padding:0 10px 6px;font-size:11px;line-height:16px}.lIVaIG_docBody{min-height:0;color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;flex-direction:column;flex:1;gap:4px;padding:2px 12px 12px;font-size:13px;line-height:22px;display:flex;overflow:auto}";
		...
		var panel_module_css_default = {
			"msgRowSystem": "lIVaIG_msgRowSystem",
			"anchorHint": "lIVaIG_anchorHint",
			"calCellToday": "lIVaIG_calCellToday",
			"itemSub": "lIVaIG_itemSub",
			"panelEmbedded": "lIVaIG_panelEmbedded",
			"crumbSep": "lIVaIG_crumbSep",
			"toggle": "lIVaIG_toggle",
			"msgSystem": "lIVaIG_msgSystem",
			"unreadBadge": "lIVaIG_unreadBadge",
			"headerButton": "lIVaIG_headerButton",
			"msgBold": "lIVaIG_msgBold",
			"msgFile": "lIVaIG_msgFile",
			"title": "lIVaIG_title",
			"calHead": "lIVaIG_calHead",
			"msgTime": "lIVaIG_msgTime",
			"calDot": "lIVaIG_calDot",
			"iconButton": "lIVaIG_iconButton",
			"drill": "lIVaIG_drill",
			"floatDock": "lIVaIG_floatDock",
			"groupHead": "lIVaIG_groupHead",
			"groupHeadName": "lIVaIG_groupHeadName",
			"itemTitleText": "lIVaIG_itemTitleText",
			"composer": "lIVaIG_composer",
			"twoPane": "lIVaIG_twoPane",
			"floatBallBadge": "lIVaIG_floatBallBadge",
			"back": "lIVaIG_back",
			"avatar": "lIVaIG_avatar",
			"readAllHint": "lIVaIG_readAllHint",
			"calBlank": "lIVaIG_calBlank",
			"eventDetailTitle": "lIVaIG_eventDetailTitle",
			"meAvatar": "lIVaIG_meAvatar",
			"msgImageFail": "lIVaIG_msgImageFail",
			"toggleActive": "lIVaIG_toggleActive",
			"itemTime": "lIVaIG_itemTime",
			"msgFileMeta": "lIVaIG_msgFileMeta",
			"composerRow": "lIVaIG_composerRow",
			"atMenu": "lIVaIG_atMenu",
			"atHint": "lIVaIG_atHint",
			"calNav": "lIVaIG_calNav",
			"floatDockBadge": "lIVaIG_floatDockBadge",
			"eventDetail": "lIVaIG_eventDetail",
			"searchInput": "lIVaIG_searchInput",
			"readAllRow": "lIVaIG_readAllRow",
			"eventTime": "lIVaIG_eventTime",
			"docBody": "lIVaIG_docBody",
			"replyBar": "lIVaIG_replyBar",
			"crumbs": "lIVaIG_crumbs",
			"msgContent": "lIVaIG_msgContent",
			"meName": "lIVaIG_meName",
			"crumbLink": "lIVaIG_crumbLink",
			"linkCardThumb": "lIVaIG_linkCardThumb",
			"groupGlyph": "lIVaIG_groupGlyph",
			"searchRow": "lIVaIG_searchRow",
			"msgStack": "lIVaIG_msgStack",
			"tabActive": "lIVaIG_tabActive",
			"floatDockOpen": "lIVaIG_floatDockOpen",
			"composerSend": "lIVaIG_composerSend",
			"lightboxPdf": "lIVaIG_lightboxPdf",
			"msgFileName": "lIVaIG_msgFileName",
			"calToday": "lIVaIG_calToday",
			"list": "lIVaIG_list",
			"calGrid": "lIVaIG_calGrid",
			"calDayNum": "lIVaIG_calDayNum",
			"docMeta": "lIVaIG_docMeta",
			"panel": "lIVaIG_panel",
			"msgAvatar": "lIVaIG_msgAvatar",
			"paneList": "lIVaIG_paneList",
			"paneHead": "lIVaIG_paneHead",
			"emojiCell": "lIVaIG_emojiCell",
			"error": "lIVaIG_error",
			"paneEmpty": "lIVaIG_paneEmpty",
			"calCellHas": "lIVaIG_calCellHas",
			"floatDockLabel": "lIVaIG_floatDockLabel",
			"linkCardDesc": "lIVaIG_linkCardDesc",
			"meAvatarFallback": "lIVaIG_meAvatarFallback",
			"composerInput": "lIVaIG_composerInput",
			"linkCardAction": "lIVaIG_linkCardAction",
			"msgAvatarFallback": "lIVaIG_msgAvatarFallback",
			"errorText": "lIVaIG_errorText",
			"msgRow": "lIVaIG_msgRow",
			"meInfo": "lIVaIG_meInfo",
			"linkCardTitle": "lIVaIG_linkCardTitle",
			"docRowWrap": "lIVaIG_docRowWrap",
			"chatHeader": "lIVaIG_chatHeader",
			"header": "lIVaIG_header",
			"groupChips": "lIVaIG_groupChips",
			"body": "lIVaIG_body",
			"linkCard": "lIVaIG_linkCard",
			"lightboxImg": "lIVaIG_lightboxImg",
			"floatBall": "lIVaIG_floatBall",
			"userGlyph": "lIVaIG_userGlyph",
			"replyCancel": "lIVaIG_replyCancel",
			"docGlyph": "lIVaIG_docGlyph",
			"msgSender": "lIVaIG_msgSender",
			"crumbCurrent": "lIVaIG_crumbCurrent",
			"brand": "lIVaIG_brand",
			"panelBanner": "lIVaIG_panelBanner",
			"more": "lIVaIG_more",
			"floatWrap": "lIVaIG_floatWrap",
			"msgReply": "lIVaIG_msgReply",
			"msgImageSkeleton": "lIVaIG_msgImageSkeleton",
			"replyText": "lIVaIG_replyText",
			"paneTitle": "lIVaIG_paneTitle",
			"paneLeft": "lIVaIG_paneLeft",
			"errorDismiss": "lIVaIG_errorDismiss",
			"msgItem": "lIVaIG_msgItem",
			"readAll": "lIVaIG_readAll",
			"meSub": "lIVaIG_meSub",
			"anchorTag": "lIVaIG_anchorTag",
			"msgQuote": "lIVaIG_msgQuote",
			"empty": "lIVaIG_empty",
			"item": "lIVaIG_item",
			"tab": "lIVaIG_tab",
			"msgImage": "lIVaIG_msgImage",
			"meCard": "lIVaIG_meCard",
			"msgFileIcon": "lIVaIG_msgFileIcon",
			"msgMetaLine": "lIVaIG_msgMetaLine",
			"calCell": "lIVaIG_calCell",
			"dayDivider": "lIVaIG_dayDivider",
			"panelToast": "lIVaIG_panelToast",
			"itemActive": "lIVaIG_itemActive",
			"itemAnchored": "lIVaIG_itemAnchored",
			"msgFileGroup": "lIVaIG_msgFileGroup",
			"lightbox": "lIVaIG_lightbox",
			"toolStatus": "lIVaIG_toolStatus",
			"eventDetailContent": "lIVaIG_eventDetailContent",
			"atGlyph": "lIVaIG_atGlyph",
			"chipBadge": "lIVaIG_chipBadge",
			"groupChipActive": "lIVaIG_groupChipActive",
			"msgFileDownload": "lIVaIG_msgFileDownload",
			"floatDockItem": "lIVaIG_floatDockItem",
			"floatBallActive": "lIVaIG_floatBallActive",
			"composerToolbar": "lIVaIG_composerToolbar",
			"itemTitle": "lIVaIG_itemTitle",
			"crumbItem": "lIVaIG_crumbItem",
			"eventDetailRow": "lIVaIG_eventDetailRow",
			"atItem": "lIVaIG_atItem",
			"calTitle": "lIVaIG_calTitle",
			"emojiPanel": "lIVaIG_emojiPanel",
			"linkCardBody": "lIVaIG_linkCardBody",
			"headerSpacer": "lIVaIG_headerSpacer",
			"toolButton": "lIVaIG_toolButton",
			"tabs": "lIVaIG_tabs",
			"groupChip": "lIVaIG_groupChip",
			"calCellSelected": "lIVaIG_calCellSelected",
			"msgFileSize": "lIVaIG_msgFileSize",
			"calDow": "lIVaIG_calDow",
			"toggleLabel": "lIVaIG_toggleLabel",
			"badge": "lIVaIG_badge",
			"msgBody": "lIVaIG_msgBody",
			"paneRight": "lIVaIG_paneRight",
			"loading": "lIVaIG_loading"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/workspace/packages/ui-yzj/src/client/todo-pane.module.css.mjs
		const css$5 = ".y6ZUxW_body{flex-direction:column;flex:1;gap:8px;min-height:0;padding:10px 12px 12px;display:flex;overflow-y:auto}.y6ZUxW_libRow{align-items:center;gap:8px;display:flex;position:relative}.y6ZUxW_libSwitch{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;align-items:center;gap:6px;max-width:240px;padding:6px 10px;font-size:12px;line-height:1;transition:border-color .15s,background .15s;display:inline-flex}.y6ZUxW_libSwitch:hover,.y6ZUxW_libSwitchOpen{border-color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-100)}.y6ZUxW_libName{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.y6ZUxW_libCaret{color:var(--dsw-alias-label-tertiary);font-size:10px}.y6ZUxW_libMenu{z-index:30;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:2px;min-width:260px;max-width:320px;max-height:300px;padding:5px;display:flex;position:absolute;top:calc(100% + 6px);left:0;overflow-y:auto;box-shadow:0 8px 28px #00000038}.y6ZUxW_libItem{color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:8px;align-items:center;gap:8px;padding:9px 10px;font-size:12.5px;line-height:1;display:flex}.y6ZUxW_libItem:hover{background:var(--dsw-alias-interactive-bg-hover)}.y6ZUxW_libItem:disabled{opacity:.5;cursor:default}.y6ZUxW_libItemActive{background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600)}.y6ZUxW_libItemName{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.y6ZUxW_libItemMeta{color:var(--dsw-alias-label-tertiary);flex-shrink:0;font-size:11px}.y6ZUxW_libCheck{color:var(--dsw-static-deepseek-500);flex-shrink:0;font-weight:700}.y6ZUxW_libBack{color:var(--dsw-static-deepseek-500);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:8px;padding:7px 10px;font-size:12px}.y6ZUxW_libBack:hover{background:var(--dsw-alias-interactive-bg-hover)}.y6ZUxW_libMenuHint{color:var(--dsw-alias-label-tertiary);padding:4px 10px 7px;font-size:11px;line-height:15px}.y6ZUxW_quick{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;align-items:center;gap:8px;padding:6px 8px 6px 10px;transition:border-color .15s;display:flex}.y6ZUxW_quick:focus-within{border-color:var(--dsw-static-deepseek-500)}.y6ZUxW_quickPlus{color:var(--dsw-alias-label-tertiary);user-select:none;font-size:15px;line-height:1}.y6ZUxW_quickInput{min-width:0;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1;font-family:inherit;font-size:13px;line-height:20px}.y6ZUxW_quickInput::placeholder{color:var(--dsw-alias-label-caption)}.y6ZUxW_quickAdd{background:var(--dsw-alias-button-info-fill);color:var(--dsw-alias-label-primary-foreground);cursor:pointer;border:none;border-radius:7px;flex-shrink:0;padding:7px 10px;font-size:12px;line-height:1}.y6ZUxW_quickAdd:hover{background:var(--dsw-alias-button-info-hover)}.y6ZUxW_quickAddDisabled{opacity:.45;cursor:default}.y6ZUxW_quickHint{color:var(--dsw-alias-label-tertiary);margin:-2px 2px 0 26px;font-size:12px;line-height:16px}.y6ZUxW_quickHint strong{color:var(--dsw-alias-label-secondary);font-weight:600}.y6ZUxW_tagRail{flex-wrap:wrap;align-items:center;gap:6px;display:flex}.y6ZUxW_tagRailSpace{flex:1}.y6ZUxW_tagChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;border-radius:999px;padding:5px 9px;font-size:12px;line-height:1;transition:border-color .15s,color .15s,background .15s}.y6ZUxW_tagChip:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.y6ZUxW_tagChipActive{border-color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600)}.y6ZUxW_libraryLink{color:var(--dsw-static-deepseek-500);white-space:nowrap;font-size:12px;text-decoration:none}.y6ZUxW_libraryLink:hover{text-decoration:underline}.y6ZUxW_list{flex-direction:column;flex:1;gap:10px;min-height:0;display:flex}.y6ZUxW_bucket{flex-direction:column;gap:4px;display:flex}.y6ZUxW_bucketHead{align-items:center;gap:6px;padding:0 2px;font-size:12px;font-weight:600;display:flex}.y6ZUxW_bucketCount{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 7px;font-size:11px;font-weight:500}.y6ZUxW_tone-danger{color:var(--dsw-static-red-400)}.y6ZUxW_tone-danger .y6ZUxW_bucketCount{background:var(--dsw-static-red-100,#ffe4e199);color:var(--dsw-static-red-400)}.y6ZUxW_tone-warn{color:#b25e00}.y6ZUxW_tone-info{color:var(--dsw-static-deepseek-600)}.y6ZUxW_tone-muted{color:var(--dsw-alias-label-secondary)}.y6ZUxW_tone-done{color:var(--dsw-alias-label-tertiary)}.y6ZUxW_row{background:var(--dsw-alias-bg-layer-1);cursor:grab;border:1px solid #0000;border-radius:10px;align-items:flex-start;gap:9px;padding:7px 9px;transition:border-color .15s,background .15s;display:flex}.y6ZUxW_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.y6ZUxW_rowOverdue{border-color:var(--dsw-static-red-100,#ffe4e18c);background:var(--dsw-alias-interactive-bg-hover-danger)}.y6ZUxW_rowDone{opacity:.62}.y6ZUxW_rowMain{text-align:left;cursor:pointer;background:0 0;border:none;flex-direction:column;flex:1;gap:3px;min-width:0;padding:0;font-family:inherit;display:flex}.y6ZUxW_rowTitle{color:var(--dsw-alias-label-primary);word-break:break-word;font-size:13px;line-height:18px}.y6ZUxW_rowDone .y6ZUxW_rowTitle{text-decoration:line-through;text-decoration-color:var(--dsw-alias-label-caption)}.y6ZUxW_rowMeta{flex-wrap:wrap;align-items:center;gap:5px;display:flex}.y6ZUxW_chip{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary);border-radius:5px;padding:3px 6px;font-size:11px;line-height:1}.y6ZUxW_chipDanger{background:var(--dsw-static-red-100,#ffe4e199);color:var(--dsw-static-red-400)}.y6ZUxW_chipWarn{color:#8a5300;background:#fff0d6d9}.y6ZUxW_chipTag{background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600);cursor:pointer;border-radius:5px;padding:3px 6px;font-size:11px;line-height:1}.y6ZUxW_chipTag:hover{background:var(--dsw-static-deepseek-500);color:var(--dsw-alias-label-primary-foreground)}.y6ZUxW_chipMuted{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:1}.y6ZUxW_dot{border:1.5px solid var(--dsw-alias-border-l3,var(--dsw-alias-border-l2));background:var(--dsw-alias-bg-base);cursor:pointer;width:18px;height:18px;color:var(--dsw-alias-label-primary-foreground);border-radius:50%;flex-shrink:0;justify-content:center;align-items:center;margin-top:1px;padding:0;transition:border-color .15s,background .15s,transform .1s;display:inline-flex}.y6ZUxW_dot:hover{border-color:var(--dsw-static-deepseek-500);transform:scale(1.08)}.y6ZUxW_dotProgress{border-color:var(--dsw-static-deepseek-500);background:linear-gradient(90deg, var(--dsw-static-deepseek-500) 50%, var(--dsw-alias-bg-base) 50%)}.y6ZUxW_dotDone{border-color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-500)}.y6ZUxW_dotBusy{opacity:.55;cursor:wait}.y6ZUxW_detail{border-left:2px solid var(--dsw-alias-border-l3,var(--dsw-alias-border-l2));flex-direction:column;gap:3px;margin:2px 2px 4px 36px;padding:4px 0 4px 10px;display:flex}.y6ZUxW_detailLine{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:16px}.y6ZUxW_detailLog{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-tertiary);border-radius:7px;flex-direction:column;gap:2px;padding:6px 8px;font-size:11px;line-height:16px;display:flex}.y6ZUxW_detailHint{color:var(--dsw-alias-label-caption);font-size:11px}.y6ZUxW_empty{color:var(--dsw-alias-label-tertiary);flex-direction:column;flex:1;justify-content:center;align-items:center;gap:8px;padding:36px 0;font-size:13px;display:flex}.y6ZUxW_emptyIcon{opacity:.75;font-size:26px}.y6ZUxW_hero{text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:10px;padding:40px 24px;display:flex}.y6ZUxW_heroIcon{background:var(--dsw-static-deepseek-100);width:44px;height:44px;color:var(--dsw-static-deepseek-600);border-radius:50%;justify-content:center;align-items:center;font-size:20px;font-weight:700;display:flex}.y6ZUxW_heroTitle{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600}.y6ZUxW_heroText{color:var(--dsw-alias-label-secondary);max-width:320px;font-size:12px;line-height:18px}.y6ZUxW_heroButton{background:var(--dsw-alias-button-info-fill);color:var(--dsw-alias-label-primary-foreground);cursor:pointer;border:none;border-radius:9px;margin-top:4px;padding:9px 22px;font-size:13px}.y6ZUxW_heroButton:hover{background:var(--dsw-alias-button-info-hover)}.y6ZUxW_foot{color:var(--dsw-alias-label-caption);text-align:center;padding-top:2px;font-size:11px;line-height:15px}.y6ZUxW_notice{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);max-width:92%;color:var(--dsw-alias-label-secondary);border-radius:8px;align-self:center;padding:7px 12px;font-size:12px;position:sticky;bottom:8px;box-shadow:0 4px 16px #0000002e}";
		...
		var todo_pane_module_css_default = {
			"libCheck": "y6ZUxW_libCheck",
			"detailLine": "y6ZUxW_detailLine",
			"quickHint": "y6ZUxW_quickHint",
			"bucketHead": "y6ZUxW_bucketHead",
			"rowMain": "y6ZUxW_rowMain",
			"chipWarn": "y6ZUxW_chipWarn",
			"dot": "y6ZUxW_dot",
			"tone-info": "y6ZUxW_tone-info",
			"emptyIcon": "y6ZUxW_emptyIcon",
			"rowMeta": "y6ZUxW_rowMeta",
			"rowDone": "y6ZUxW_rowDone",
			"chipDanger": "y6ZUxW_chipDanger",
			"empty": "y6ZUxW_empty",
			"tagChip": "y6ZUxW_tagChip",
			"quickPlus": "y6ZUxW_quickPlus",
			"heroIcon": "y6ZUxW_heroIcon",
			"tone-done": "y6ZUxW_tone-done",
			"detail": "y6ZUxW_detail",
			"rowTitle": "y6ZUxW_rowTitle",
			"chipMuted": "y6ZUxW_chipMuted",
			"libCaret": "y6ZUxW_libCaret",
			"quick": "y6ZUxW_quick",
			"tagRailSpace": "y6ZUxW_tagRailSpace",
			"heroButton": "y6ZUxW_heroButton",
			"detailLog": "y6ZUxW_detailLog",
			"foot": "y6ZUxW_foot",
			"detailHint": "y6ZUxW_detailHint",
			"libItemMeta": "y6ZUxW_libItemMeta",
			"libItem": "y6ZUxW_libItem",
			"libMenuHint": "y6ZUxW_libMenuHint",
			"libRow": "y6ZUxW_libRow",
			"quickAdd": "y6ZUxW_quickAdd",
			"tagRail": "y6ZUxW_tagRail",
			"libName": "y6ZUxW_libName",
			"quickAddDisabled": "y6ZUxW_quickAddDisabled",
			"row": "y6ZUxW_row",
			"dotProgress": "y6ZUxW_dotProgress",
			"dotBusy": "y6ZUxW_dotBusy",
			"libItemActive": "y6ZUxW_libItemActive",
			"quickInput": "y6ZUxW_quickInput",
			"tone-muted": "y6ZUxW_tone-muted",
			"chip": "y6ZUxW_chip",
			"hero": "y6ZUxW_hero",
			"rowOverdue": "y6ZUxW_rowOverdue",
			"tagChipActive": "y6ZUxW_tagChipActive",
			"libSwitchOpen": "y6ZUxW_libSwitchOpen",
			"bucket": "y6ZUxW_bucket",
			"libMenu": "y6ZUxW_libMenu",
			"tone-danger": "y6ZUxW_tone-danger",
			"heroText": "y6ZUxW_heroText",
			"libBack": "y6ZUxW_libBack",
			"list": "y6ZUxW_list",
			"tone-warn": "y6ZUxW_tone-warn",
			"libItemName": "y6ZUxW_libItemName",
			"libraryLink": "y6ZUxW_libraryLink",
			"libSwitch": "y6ZUxW_libSwitch",
			"body": "y6ZUxW_body",
			"bucketCount": "y6ZUxW_bucketCount",
			"notice": "y6ZUxW_notice",
			"dotDone": "y6ZUxW_dotDone",
			"heroTitle": "y6ZUxW_heroTitle",
			"chipTag": "y6ZUxW_chipTag"
		};
		//#endregion
		...
		*  without hand-editing host config. */
		...
		//#endregion
		//#region \0dsh-css:/workspace/packages/ui-yzj/src/client/calendar-pane.module.css.mjs
		const css$4 = ".bWz6qG_page{flex-direction:column;flex:1;height:100%;min-height:0;display:flex}.bWz6qG_toolbar{flex:none;justify-content:space-between;align-items:center;gap:12px;padding:12px 16px 10px;display:flex}.bWz6qG_toolbarLeft{align-items:center;gap:8px;min-width:0;display:flex}.bWz6qG_today{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:8px;padding:6px 14px;font-size:13px}.bWz6qG_today:hover{background:var(--dsw-alias-interactive-bg-hover)}.bWz6qG_nav{align-items:center;display:flex}.bWz6qG_icon{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;justify-content:center;align-items:center;font-size:18px;display:flex}.bWz6qG_icon:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.bWz6qG_range{color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;font-size:15px;font-weight:600;overflow:hidden}.bWz6qG_views{background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex:none;padding:2px;display:flex}.bWz6qG_view{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:6px 14px;font-size:13px;line-height:1}.bWz6qG_viewOn{background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);font-weight:600;box-shadow:0 1px 2px #0000000f}.bWz6qG_week{flex-direction:column;flex:1;min-height:0;display:flex}.bWz6qG_weekHead{border-top:1px solid var(--dsw-alias-border-l2);border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;display:flex}.bWz6qG_gutter{width:52px;color:var(--dsw-alias-label-caption);flex:none;justify-content:center;align-items:flex-end;padding-bottom:6px;font-size:11px;display:flex}.bWz6qG_dayHead{border:none;border-left:1px solid var(--dsw-alias-border-l2);cursor:pointer;background:0 0;flex-direction:column;flex:1;align-items:center;gap:2px;padding:8px 0;display:flex}.bWz6qG_dayWeek{color:var(--dsw-alias-label-tertiary);font-size:12px}.bWz6qG_dayDate{color:var(--dsw-alias-label-primary);justify-content:center;align-items:center;width:24px;height:24px;font-size:16px;font-weight:600;display:flex}.bWz6qG_dayHeadToday .bWz6qG_dayDate{color:var(--dsw-static-deepseek-500)}.bWz6qG_dayHeadOn .bWz6qG_dayDate{background:var(--dsw-static-deepseek-500);color:#fff;border-radius:50%}.bWz6qG_weekBody{flex:1;min-height:0;display:flex;overflow-y:auto}.bWz6qG_times{flex:none;width:52px}.bWz6qG_timeRow{position:relative}.bWz6qG_timeLabel{color:var(--dsw-alias-label-caption);font-size:11px;position:absolute;top:-7px;right:6px}.bWz6qG_grid{flex:1;display:flex;position:relative}.bWz6qG_col{border-left:1px solid var(--dsw-alias-border-l2);background-image:repeating-linear-gradient(to bottom, transparent, transparent 51px, var(--dsw-alias-border-l2) 51px, var(--dsw-alias-border-l2) 52px);flex:1;position:relative}.bWz6qG_colToday{background-color:color-mix(in srgb, var(--dsw-static-deepseek-500) 6%, transparent)}.bWz6qG_colOn{background-color:color-mix(in srgb, var(--dsw-static-deepseek-500) 10%, transparent)}.bWz6qG_block{z-index:1;cursor:pointer;text-align:left;border:none;border-radius:6px;flex-direction:column;align-items:flex-start;gap:1px;padding:2px 6px;display:flex;position:absolute;left:3px;right:3px;overflow:hidden}.bWz6qG_blockTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;max-width:100%;font-size:12px;font-weight:500;overflow:hidden}.bWz6qG_blockTime{color:var(--dsw-alias-label-tertiary);font-size:11px}.bWz6qG_blockOn{outline:1px solid var(--dsw-static-deepseek-500)}.bWz6qG_block_blue{background:color-mix(in srgb, var(--dsw-static-deepseek-500) 16%, #fff);box-shadow:inset 2px 0 var(--dsw-static-deepseek-500)}.bWz6qG_block_green{background:#ebf9ee;box-shadow:inset 2px 0 #2a9f47}.bWz6qG_block_orange{background:#fff4e5;box-shadow:inset 2px 0 #ff9500}.bWz6qG_block_red{background:#fcebea;box-shadow:inset 2px 0 #e5352b}.bWz6qG_block_purple{background:#f3eefe;box-shadow:inset 2px 0 #7c3aed}.bWz6qG_now{z-index:3;border-top:1.5px solid #e5352b;height:0;position:absolute;left:0;right:0}.bWz6qG_nowDot{background:#e5352b;border-radius:50%;width:8px;height:8px;position:absolute;top:-4px;left:-3px}.bWz6qG_month{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;flex:1;min-height:0;display:flex}.bWz6qG_monthHead{border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;grid-template-columns:repeat(7,1fr);display:grid}.bWz6qG_monthHeadCell{text-align:center;color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:12px}.bWz6qG_monthGrid{flex-direction:column;flex:1;min-height:0;display:flex;overflow-y:auto}.bWz6qG_monthRow{flex:1;grid-template-columns:repeat(7,1fr);min-height:88px;display:grid}.bWz6qG_monthCell{border-right:1px solid var(--dsw-alias-border-l2);border-bottom:1px solid var(--dsw-alias-border-l2);cursor:pointer;flex-direction:column;gap:3px;padding:6px 6px 4px;display:flex;overflow:hidden}.bWz6qG_monthCell:hover{background:var(--dsw-alias-interactive-bg-hover)}.bWz6qG_monthCellMuted .bWz6qG_monthDate{color:var(--dsw-alias-label-caption)}.bWz6qG_monthCellOn{background:color-mix(in srgb, var(--dsw-static-deepseek-500) 8%, transparent)}.bWz6qG_monthDateRow{justify-content:flex-end;display:flex}.bWz6qG_monthDate{color:var(--dsw-alias-label-primary);justify-content:center;align-items:center;width:22px;height:22px;font-size:13px;display:flex}.bWz6qG_monthDateToday{background:var(--dsw-static-deepseek-500);color:#fff;border-radius:50%;font-weight:600}.bWz6qG_monthEvents{flex-direction:column;gap:2px;display:flex;overflow:hidden}.bWz6qG_monthEv{white-space:nowrap;cursor:pointer;text-align:left;border:none;border-radius:4px;align-items:center;gap:4px;padding:1px 4px;font-size:11px;display:flex;overflow:hidden}.bWz6qG_monthEvOn{outline:1px solid var(--dsw-static-deepseek-500)}.bWz6qG_monthEvTime{color:var(--dsw-alias-label-tertiary);flex:none}.bWz6qG_monthEvTitle{text-overflow:ellipsis;color:var(--dsw-alias-label-primary);overflow:hidden}.bWz6qG_ev_blue{background:color-mix(in srgb, var(--dsw-static-deepseek-500) 16%, #fff)}.bWz6qG_ev_green{background:#ebf9ee}.bWz6qG_ev_orange{background:#fff4e5}.bWz6qG_ev_red{background:#fcebea}.bWz6qG_ev_purple{background:#f3eefe}.bWz6qG_monthMore{color:var(--dsw-alias-label-tertiary);padding-left:4px;font-size:11px}.bWz6qG_year{border-top:1px solid var(--dsw-alias-border-l2);flex:1;grid-template-columns:repeat(4,1fr);align-content:start;gap:16px;padding:16px 18px;display:grid;overflow-y:auto}.bWz6qG_yearMonth{cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;padding:8px}.bWz6qG_yearMonth:hover{background:var(--dsw-alias-interactive-bg-hover)}.bWz6qG_yearTitle{color:var(--dsw-alias-label-primary);margin-bottom:6px;font-size:14px;font-weight:600}.bWz6qG_yearTitleOn{color:var(--dsw-static-deepseek-500)}.bWz6qG_yearWeek,.bWz6qG_yearDays{grid-template-columns:repeat(7,1fr);display:grid}.bWz6qG_yearWcell{text-align:center;color:var(--dsw-alias-label-caption);padding:2px 0;font-size:10px}.bWz6qG_yearDay{height:22px;color:var(--dsw-alias-label-primary);justify-content:center;align-items:center;font-size:11px;display:flex;position:relative}.bWz6qG_yearDayEmpty{visibility:hidden}.bWz6qG_yearDayToday{background:var(--dsw-static-deepseek-500);color:#fff;border-radius:50%;width:20px;height:20px;margin:auto;font-weight:600}.bWz6qG_yearDot{background:#ff9500;border-radius:50%;width:4px;height:4px;position:absolute;bottom:1px;left:50%;transform:translate(-50%)}.bWz6qG_detail{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;flex:none;margin:0 16px 12px;padding:10px 12px}.bWz6qG_detailTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600}.bWz6qG_detailRow{color:var(--dsw-alias-label-secondary);margin-top:4px;font-size:12px}.bWz6qG_detailBody{color:var(--dsw-alias-label-primary);white-space:pre-wrap;margin-top:6px;font-size:12px}";
		...
		var calendar_pane_module_css_default = {
			"detail": "bWz6qG_detail",
			"blockTitle": "bWz6qG_blockTitle",
			"dayHead": "bWz6qG_dayHead",
			"detailBody": "bWz6qG_detailBody",
			"monthDate": "bWz6qG_monthDate",
			"colToday": "bWz6qG_colToday",
			"colOn": "bWz6qG_colOn",
			"ev_orange": "bWz6qG_ev_orange",
			"range": "bWz6qG_range",
			"dayHeadOn": "bWz6qG_dayHeadOn",
			"yearWcell": "bWz6qG_yearWcell",
			"block_blue": "bWz6qG_block_blue",
			"monthGrid": "bWz6qG_monthGrid",
			"timeRow": "bWz6qG_timeRow",
			"nowDot": "bWz6qG_nowDot",
			"monthEvents": "bWz6qG_monthEvents",
			"monthCellOn": "bWz6qG_monthCellOn",
			"icon": "bWz6qG_icon",
			"today": "bWz6qG_today",
			"viewOn": "bWz6qG_viewOn",
			"monthDateRow": "bWz6qG_monthDateRow",
			"yearDot": "bWz6qG_yearDot",
			"block_orange": "bWz6qG_block_orange",
			"ev_purple": "bWz6qG_ev_purple",
			"detailRow": "bWz6qG_detailRow",
			"views": "bWz6qG_views",
			"monthEvOn": "bWz6qG_monthEvOn",
			"times": "bWz6qG_times",
			"block_purple": "bWz6qG_block_purple",
			"block": "bWz6qG_block",
			"monthHeadCell": "bWz6qG_monthHeadCell",
			"monthCell": "bWz6qG_monthCell",
			"monthMore": "bWz6qG_monthMore",
			"yearDayToday": "bWz6qG_yearDayToday",
			"yearMonth": "bWz6qG_yearMonth",
			"yearDayEmpty": "bWz6qG_yearDayEmpty",
			"yearTitleOn": "bWz6qG_yearTitleOn",
			"blockOn": "bWz6qG_blockOn",
			"gutter": "bWz6qG_gutter",
			"toolbarLeft": "bWz6qG_toolbarLeft",
			"block_green": "bWz6qG_block_green",
			"timeLabel": "bWz6qG_timeLabel",
			"week": "bWz6qG_week",
			"now": "bWz6qG_now",
			"monthRow": "bWz6qG_monthRow",
			"block_red": "bWz6qG_block_red",
			"col": "bWz6qG_col",
			"ev_red": "bWz6qG_ev_red",
			"yearDays": "bWz6qG_yearDays",
			"ev_blue": "bWz6qG_ev_blue",
			"detailTitle": "bWz6qG_detailTitle",
			"weekBody": "bWz6qG_weekBody",
			"page": "bWz6qG_page",
			"dayHeadToday": "bWz6qG_dayHeadToday",
			"monthCellMuted": "bWz6qG_monthCellMuted",
			"nav": "bWz6qG_nav",
			"weekHead": "bWz6qG_weekHead",
			"year": "bWz6qG_year",
			"yearTitle": "bWz6qG_yearTitle",
			"monthEvTime": "bWz6qG_monthEvTime",
			"grid": "bWz6qG_grid",
			"monthDateToday": "bWz6qG_monthDateToday",
			"dayWeek": "bWz6qG_dayWeek",
			"month": "bWz6qG_month",
			"ev_green": "bWz6qG_ev_green",
			"toolbar": "bWz6qG_toolbar",
			"monthHead": "bWz6qG_monthHead",
			"monthEvTitle": "bWz6qG_monthEvTitle",
			"monthEv": "bWz6qG_monthEv",
			"dayDate": "bWz6qG_dayDate",
			"blockTime": "bWz6qG_blockTime",
			"yearWeek": "bWz6qG_yearWeek",
			"view": "bWz6qG_view",
			"yearDay": "bWz6qG_yearDay"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/workspace/packages/ui-yzj/src/client/advance-pane.module.css.mjs
		const css$3 = ".Q5rrva_body{flex:1;gap:12px;min-height:0;padding:10px 12px 12px;display:flex;overflow:hidden}.Q5rrva_queue{flex-direction:column;flex:0 0 260px;gap:10px;min-height:0;padding-right:4px;display:flex;overflow-y:auto}.Q5rrva_queueHead{flex-direction:column;gap:2px;display:flex}.Q5rrva_queueHead b{color:var(--dsw-alias-label-primary);font-size:14px}.Q5rrva_queueHead span{color:var(--dsw-alias-label-tertiary);font-size:11px}.Q5rrva_queueGroup{flex-direction:column;gap:6px;display:flex}.Q5rrva_queueLabel{color:var(--dsw-alias-label-secondary);justify-content:space-between;align-items:center;font-size:11px;display:flex}.Q5rrva_queueCount{text-align:center;background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l2);min-width:18px;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 5px;font-size:10px}.Q5rrva_queueItem{text-align:left;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);cursor:pointer;border-radius:10px;flex-direction:column;gap:3px;padding:8px 10px;transition:border-color .15s,background .15s;display:flex}.Q5rrva_queueItem:hover{border-color:var(--dsw-static-deepseek-500)}.Q5rrva_queueItemOn{border-color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-100)}.Q5rrva_queueTitle{align-items:center;gap:6px;min-width:0;display:flex}.Q5rrva_queueTitle b{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;overflow:hidden}.Q5rrva_queueItem p{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;margin:0;font-size:11px;overflow:hidden}.Q5rrva_queueEmpty{border:1px dashed var(--dsw-alias-border-l2);border-radius:10px;padding:8px 10px}.Q5rrva_queueEmpty b{color:var(--dsw-alias-label-secondary);font-size:12px}.Q5rrva_queueEmpty p{color:var(--dsw-alias-label-tertiary);margin:2px 0 0;font-size:11px}.Q5rrva_dot{background:var(--dsw-alias-border-l2);border-radius:50%;flex:0 0 8px;width:8px;height:8px}.Q5rrva_dot_red{background:#e5484d}.Q5rrva_dot_blue{background:var(--dsw-static-deepseek-500)}.Q5rrva_dot_green{background:#2f9e44}.Q5rrva_dot_gray{background:var(--dsw-alias-border-l2)}.Q5rrva_detail{flex-direction:column;flex:1;gap:12px;min-width:0;min-height:0;display:flex;overflow-y:auto}.Q5rrva_detailHead{flex-direction:column;gap:4px;display:flex}.Q5rrva_kicker{color:var(--dsw-alias-label-tertiary);align-items:center;gap:8px;font-size:11px;display:flex}.Q5rrva_feedbackBtn{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:8px;margin-left:auto;padding:4px 10px;font-size:12px;font-weight:600}.Q5rrva_feedbackBtn:hover{background:var(--dsw-alias-interactive-bg-hover)}.Q5rrva_stagePill{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);border-radius:999px;align-items:center;padding:2px 8px;font-size:11px;display:inline-flex}.Q5rrva_pill_red{color:#e5484d;border-color:#e5484d}.Q5rrva_pill_green{color:#2f9e44;border-color:#2f9e44}.Q5rrva_pill_blue{border-color:var(--dsw-static-deepseek-500);color:var(--dsw-static-deepseek-500)}.Q5rrva_pill_gray{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.Q5rrva_detailHead h1{color:var(--dsw-alias-label-primary);margin:0;font-size:17px;line-height:1.3}.Q5rrva_meta{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;gap:10px;font-size:11.5px;display:flex}.Q5rrva_meta a{color:var(--dsw-static-deepseek-500);text-decoration:none}.Q5rrva_metrics{flex-wrap:wrap;gap:8px;display:flex}.Q5rrva_metric{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;flex-direction:column;flex:120px;gap:2px;min-width:120px;padding:8px 10px;display:flex}.Q5rrva_metric span{color:var(--dsw-alias-label-tertiary);font-size:11px}.Q5rrva_metric b{color:var(--dsw-alias-label-primary);font-size:16px}.Q5rrva_metric small{color:var(--dsw-alias-label-tertiary);font-size:10.5px}.Q5rrva_detailGrid{align-items:flex-start;gap:12px;display:flex}.Q5rrva_main{flex-direction:column;flex:1;gap:12px;min-width:0;display:flex}.Q5rrva_side{flex-direction:column;flex:0 0 240px;gap:12px;display:flex}.Q5rrva_section{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.Q5rrva_sectionHead{justify-content:space-between;align-items:baseline;gap:8px;display:flex}.Q5rrva_sectionHead h2{color:var(--dsw-alias-label-primary);margin:0;font-size:13px}.Q5rrva_sectionHead small{color:var(--dsw-alias-label-tertiary);font-size:11px}.Q5rrva_goal{color:var(--dsw-alias-label-primary);margin:0;font-size:13px;line-height:1.5}.Q5rrva_background{color:var(--dsw-alias-label-secondary);margin:0;font-size:12px}.Q5rrva_quiet{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px}.Q5rrva_decision{flex-direction:column;gap:6px;display:flex}.Q5rrva_decision h3{color:var(--dsw-alias-label-primary);margin:0;font-size:13px}.Q5rrva_decision p{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;margin:0;font-size:12px}.Q5rrva_verbs{flex-wrap:wrap;gap:8px;display:flex}.Q5rrva_verbs button{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;padding:6px 12px;font-size:12px}.Q5rrva_verbs button:disabled{opacity:.6;cursor:default}.Q5rrva_timeline{flex-direction:column;gap:10px;display:flex}.Q5rrva_timeItem{align-items:flex-start;gap:8px;display:flex}.Q5rrva_time{color:var(--dsw-alias-label-tertiary);flex:none;min-width:96px;padding-top:2px;font-size:10.5px}.Q5rrva_mark{border-radius:50%;flex:0 0 8px;width:8px;height:8px;margin-top:4px}.Q5rrva_mark_blue{background:var(--dsw-static-deepseek-500)}.Q5rrva_mark_green{background:#2f9e44}.Q5rrva_mark_red{background:#e5484d}.Q5rrva_timeCopy{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.Q5rrva_timeCopy b{color:var(--dsw-alias-label-primary);font-size:12.5px}.Q5rrva_timeCopy p{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;margin:0;font-size:11.5px}.Q5rrva_timeMeta{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;align-items:center;gap:8px;font-size:10.5px;display:flex}.Q5rrva_refs{text-overflow:ellipsis;white-space:nowrap;max-width:240px;overflow:hidden}.Q5rrva_jump{color:var(--dsw-static-deepseek-500);cursor:pointer;background:0 0;border:none;padding:0;font-size:10.5px}.Q5rrva_more{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;border-radius:999px;align-self:flex-start;padding:5px 12px;font-size:11.5px}.Q5rrva_sourceList{flex-direction:column;gap:8px;display:flex}.Q5rrva_source{align-items:center;gap:8px;min-width:0;display:flex}.Q5rrva_sourceIcon{background:var(--dsw-static-deepseek-100);width:22px;height:22px;color:var(--dsw-static-deepseek-500);border-radius:6px;flex:0 0 22px;justify-content:center;align-items:center;font-size:11px;display:inline-flex}.Q5rrva_sourceCopy{flex-direction:column;flex:1;min-width:0;display:flex}.Q5rrva_sourceCopy b{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11.5px;overflow:hidden}.Q5rrva_sourceCopy span{color:var(--dsw-alias-label-tertiary);font-size:10px}.Q5rrva_sourceState{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary);border-radius:999px;flex:none;padding:1px 6px;font-size:10px;font-style:normal}.Q5rrva_state_已确认{color:#2f9e44;border-color:#2f9e44}.Q5rrva_state_未达标{color:#e5484d;border-color:#e5484d}.Q5rrva_state_等待中{color:#e8a33d;border-color:#e8a33d}.Q5rrva_sideNote{color:var(--dsw-alias-label-tertiary);margin:0;font-size:10.5px;line-height:1.5}.Q5rrva_hero{text-align:center;flex-direction:column;align-items:center;gap:8px;max-width:380px;margin:auto;display:flex}.Q5rrva_hero h2{color:var(--dsw-alias-label-primary);margin:0;font-size:15px}.Q5rrva_hero p{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px}.Q5rrva_hint{color:var(--dsw-alias-label-tertiary);margin:auto;font-size:12px}.Q5rrva_primary{background:var(--dsw-static-deepseek-500);color:#fff;cursor:pointer;border:none;border-radius:999px;padding:7px 16px;font-size:12.5px}.Q5rrva_primary:disabled{opacity:.6;cursor:default}.Q5rrva_error{color:#e5484d;font-size:11.5px}.Q5rrva_mask{z-index:40;background:#00000059;justify-content:center;align-items:center;display:flex;position:absolute;inset:0}.Q5rrva_modal{background:var(--dsw-alias-bg-base);border:1px solid var(--dsw-alias-border-l2);border-radius:14px;flex-direction:column;gap:10px;width:min(480px,92%);max-height:86%;padding:14px 16px;display:flex;overflow-y:auto}.Q5rrva_modalHead{justify-content:space-between;align-items:center;display:flex}.Q5rrva_modalHead h2{color:var(--dsw-alias-label-primary);margin:0;font-size:14px}.Q5rrva_modalHead button{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;font-size:16px}.Q5rrva_fieldLabel{color:var(--dsw-alias-label-secondary);flex-direction:column;gap:4px;font-size:11.5px;display:flex}.Q5rrva_fieldLabel input,.Q5rrva_fieldLabel textarea{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);resize:vertical;border-radius:8px;padding:7px 9px;font-size:12.5px}.Q5rrva_fieldLabel textarea{min-height:56px}.Q5rrva_fieldRow{gap:10px;display:flex}.Q5rrva_fieldRow .Q5rrva_fieldLabel{flex:1}.Q5rrva_modalFoot{justify-content:flex-end;gap:8px;display:flex}.Q5rrva_modalFoot button{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;padding:6px 14px;font-size:12px}.Q5rrva_modalFoot .Q5rrva_primary{background:var(--dsw-static-deepseek-500);color:#fff;border:none}";
		...
		var advance_pane_module_css_default = {
			"mark_red": "Q5rrva_mark_red",
			"state_等待中": "Q5rrva_state_等待中",
			"timeline": "Q5rrva_timeline",
			"time": "Q5rrva_time",
			"hero": "Q5rrva_hero",
			"fieldRow": "Q5rrva_fieldRow",
			"stagePill": "Q5rrva_stagePill",
			"mark_blue": "Q5rrva_mark_blue",
			"mark": "Q5rrva_mark",
			"state_已确认": "Q5rrva_state_已确认",
			"error": "Q5rrva_error",
			"dot": "Q5rrva_dot",
			"more": "Q5rrva_more",
			"sourceCopy": "Q5rrva_sourceCopy",
			"mask": "Q5rrva_mask",
			"modalHead": "Q5rrva_modalHead",
			"goal": "Q5rrva_goal",
			"queueLabel": "Q5rrva_queueLabel",
			"queueItem": "Q5rrva_queueItem",
			"modal": "Q5rrva_modal",
			"mark_green": "Q5rrva_mark_green",
			"verbs": "Q5rrva_verbs",
			"queueItemOn": "Q5rrva_queueItemOn",
			"sourceList": "Q5rrva_sourceList",
			"refs": "Q5rrva_refs",
			"sourceIcon": "Q5rrva_sourceIcon",
			"jump": "Q5rrva_jump",
			"sourceState": "Q5rrva_sourceState",
			"pill_gray": "Q5rrva_pill_gray",
			"section": "Q5rrva_section",
			"timeItem": "Q5rrva_timeItem",
			"timeMeta": "Q5rrva_timeMeta",
			"source": "Q5rrva_source",
			"primary": "Q5rrva_primary",
			"state_未达标": "Q5rrva_state_未达标",
			"pill_blue": "Q5rrva_pill_blue",
			"dot_green": "Q5rrva_dot_green",
			"queueTitle": "Q5rrva_queueTitle",
			"side": "Q5rrva_side",
			"metric": "Q5rrva_metric",
			"hint": "Q5rrva_hint",
			"quiet": "Q5rrva_quiet",
			"modalFoot": "Q5rrva_modalFoot",
			"dot_gray": "Q5rrva_dot_gray",
			"sectionHead": "Q5rrva_sectionHead",
			"detailGrid": "Q5rrva_detailGrid",
			"pill_green": "Q5rrva_pill_green",
			"timeCopy": "Q5rrva_timeCopy",
			"meta": "Q5rrva_meta",
			"dot_red": "Q5rrva_dot_red",
			"queueCount": "Q5rrva_queueCount",
			"queue": "Q5rrva_queue",
			"dot_blue": "Q5rrva_dot_blue",
			"metrics": "Q5rrva_metrics",
			"background": "Q5rrva_background",
			"decision": "Q5rrva_decision",
			"pill_red": "Q5rrva_pill_red",
			"body": "Q5rrva_body",
			"sideNote": "Q5rrva_sideNote",
			"fieldLabel": "Q5rrva_fieldLabel",
			"queueGroup": "Q5rrva_queueGroup",
			"detail": "Q5rrva_detail",
			"queueEmpty": "Q5rrva_queueEmpty",
			"feedbackBtn": "Q5rrva_feedbackBtn",
			"detailHead": "Q5rrva_detailHead",
			"main": "Q5rrva_main",
			"kicker": "Q5rrva_kicker",
			"queueHead": "Q5rrva_queueHead"
		};
		//#endregion
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("aside", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: "我的推进" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "当前需要关注的事项" })]
							}),
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
											...
											children: [
												...
												stage === "decision-needed" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [latestDecision !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: asString$5(latestDecision.summary) }), asString$5(latestDecision.detail) !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: asString$5(latestDecision.detail) })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/workspace/packages/ui-yzj/src/client/overlay.module.css.mjs
		const css$2 = "[data-pane=conversation],[class*=centerCol]{position:relative}[data-dsh-yzj-view]{z-index:60;background:var(--dsw-alias-bg-base);min-height:0;display:none;position:absolute;inset:0}html[data-dsh-yzj-active]:not([data-dsh-taskboard-active]):not([data-dsh-ssh-active]) [data-dsh-yzj-view]{flex-direction:column;min-height:0;display:flex}html[data-dsh-yzj-active]:not([data-dsh-taskboard-active]):not([data-dsh-ssh-active]) [data-pane=conversation]>:not([data-dsh-yzj-view]),html[data-dsh-yzj-active]:not([data-dsh-taskboard-active]):not([data-dsh-ssh-active]) [class*=centerCol]>:not([data-dsh-yzj-view]){display:none!important}.qP6ZSW_entryHost{flex:none;width:100%}";
		...
		var overlay_module_css_default = { "entryHost": "qP6ZSW_entryHost" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/workspace/packages/ui-yzj/src/client/robot-pane.module.css.mjs
		const css$1 = ".NBqibq_pane{flex-direction:column;gap:16px;height:100%;padding:16px;display:flex;overflow-y:auto}.NBqibq_section{flex-direction:column;gap:8px;display:flex}.NBqibq_sectionTitle{color:var(--dsw-text-primary);margin:0;font-size:13px;font-weight:600}.NBqibq_hint{color:var(--dsw-text-secondary);margin:0;font-size:12px}.NBqibq_channelList,.NBqibq_overrideList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.NBqibq_channelRow{background:var(--dsw-surface-raised);border-radius:8px;align-items:center;gap:8px;padding:8px 10px;font-size:12px;display:flex}.NBqibq_dotOn,.NBqibq_dotOff{border-radius:50%;flex:none;width:8px;height:8px}.NBqibq_dotOn{background:var(--dsw-status-success,#22c55e)}.NBqibq_dotOff{background:var(--dsw-text-faint,#94a3b8)}.NBqibq_channelName{color:var(--dsw-text-primary);font-weight:600}.NBqibq_channelMeta{color:var(--dsw-text-secondary)}.NBqibq_channelError{color:var(--dsw-status-danger,#ef4444);cursor:help;margin-left:auto;font-weight:700}.NBqibq_editor{background:var(--dsw-surface-raised);border-radius:10px;flex-direction:column;gap:10px;padding:12px;display:flex}.NBqibq_field{flex-direction:column;gap:4px;display:flex}.NBqibq_fieldLabel{color:var(--dsw-text-secondary);font-size:11px}.NBqibq_select{border:1px solid var(--dsw-border,#d4d4d8);background:var(--dsw-surface,#fff);color:var(--dsw-text-primary);border-radius:6px;padding:6px 8px;font-size:12px}.NBqibq_select:disabled{opacity:.5}.NBqibq_actions{gap:8px;display:flex}.NBqibq_primary,.NBqibq_secondary{cursor:pointer;border:1px solid #0000;border-radius:6px;padding:6px 14px;font-size:12px}.NBqibq_primary{background:var(--dsw-accent,#2563eb);color:var(--dsw-text-on-accent,#fff)}.NBqibq_primary:disabled{opacity:.5;cursor:default}.NBqibq_secondary{border-color:var(--dsw-border,#d4d4d8);color:var(--dsw-text-primary);background:0 0}.NBqibq_secondary:disabled{opacity:.5;cursor:default}.NBqibq_note{color:var(--dsw-text-secondary);margin:0;font-size:12px}.NBqibq_overrideRow{display:flex}.NBqibq_overridePick{background:var(--dsw-surface-raised);cursor:pointer;text-align:left;border:1px solid #0000;border-radius:8px;flex:1;justify-content:space-between;align-items:center;gap:8px;padding:8px 10px;font-size:12px;display:flex}.NBqibq_overridePick:hover{border-color:var(--dsw-border,#d4d4d8)}.NBqibq_overrideName{color:var(--dsw-text-primary);font-weight:600}.NBqibq_overrideMeta{color:var(--dsw-text-secondary)}.NBqibq_channelCwd{color:var(--dsw-text-faint,#94a3b8);font-size:11px;font-family:var(--dsw-font-mono,ui-monospace, monospace);text-overflow:ellipsis;white-space:nowrap;max-width:220px;margin-left:auto;overflow:hidden}.NBqibq_shareList{flex-direction:column;gap:4px;max-height:180px;margin:0;padding:0;list-style:none;display:flex;overflow-y:auto}.NBqibq_shareRow{background:var(--dsw-surface,#fff);border-radius:6px;justify-content:space-between;align-items:baseline;gap:8px;padding:5px 8px;font-size:12px;display:flex}.NBqibq_shareName{color:var(--dsw-text-primary);text-overflow:ellipsis;white-space:nowrap;font-weight:600;overflow:hidden}.NBqibq_shareMeta{color:var(--dsw-text-secondary);flex:none;font-size:11px}.NBqibq_input,.NBqibq_textarea{border:1px solid var(--dsw-border,#d4d4d8);background:var(--dsw-surface,#fff);color:var(--dsw-text-primary);resize:vertical;border-radius:6px;padding:6px 8px;font-family:inherit;font-size:12px}.NBqibq_input:focus,.NBqibq_textarea:focus{border-color:var(--dsw-accent,#2563eb);outline:none}.NBqibq_routeEditor{flex-wrap:wrap;align-items:center;gap:6px;display:flex}.NBqibq_miniSelect{border:1px solid var(--dsw-border,#d4d4d8);background:var(--dsw-surface,#fff);color:var(--dsw-text-primary);border-radius:6px;max-width:130px;padding:3px 6px;font-size:11px}.NBqibq_miniSelect:disabled{opacity:.5}.NBqibq_danger{border:1px solid var(--dsw-border,#d4d4d8);color:var(--dsw-status-danger,#ef4444);cursor:pointer;background:0 0;border-radius:6px;padding:3px 10px;font-size:11px}.NBqibq_dangerActive{background:var(--dsw-status-danger,#ef4444);color:var(--dsw-text-on-accent,#fff);border-color:#0000}.NBqibq_addRow{align-items:flex-end;gap:8px;display:flex}.NBqibq_addRow .NBqibq_field{flex:1;min-width:0}.NBqibq_channelPick{background:var(--dsw-surface-raised);cursor:pointer;text-align:left;border:1px solid #0000;border-radius:8px;align-items:center;gap:8px;width:100%;padding:8px 10px;font-size:12px;display:flex}.NBqibq_channelPick:hover{border-color:var(--dsw-border,#d4d4d8)}.NBqibq_groupCount{color:var(--dsw-text-secondary);flex:none;margin-left:auto;font-size:11px}.NBqibq_detailHead{align-items:center;gap:8px;display:flex}.NBqibq_detailHead .NBqibq_sectionTitle{flex:1}.NBqibq_groupCard{background:var(--dsw-surface-raised);border-radius:8px;flex-direction:column;gap:6px;padding:8px 10px;display:flex}.NBqibq_groupCardHead{justify-content:space-between;align-items:baseline;gap:8px;display:flex}.NBqibq_guideBox{background:var(--dsw-surface-raised);border-radius:8px;flex-direction:column;gap:6px;padding:10px 12px;display:flex}.NBqibq_guideBox .NBqibq_hint{line-height:1.6}.NBqibq_groupFiles{background:var(--dsw-surface,#fff);border:1px solid var(--dsw-border,#d4d4d8);border-radius:8px;flex-direction:column;gap:6px;padding:8px 10px;display:flex}.NBqibq_groupFilesTitle{color:var(--dsw-text-primary);margin:0;font-size:12px;font-weight:600}.NBqibq_shareOpen{cursor:pointer;text-align:left;background:0 0;border:none;justify-content:space-between;align-items:baseline;gap:8px;width:100%;padding:4px 2px;font-family:inherit;font-size:12px;display:flex}.NBqibq_shareOpen:hover .NBqibq_shareName{color:var(--dsw-accent,#2563eb)}.NBqibq_sharePreview{background:var(--dsw-surface,#fff);border:1px solid var(--dsw-border,#d4d4d8);border-radius:8px;flex-direction:column;gap:6px;padding:8px 10px;display:flex}.NBqibq_sharePreviewHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.NBqibq_sharePreviewBody{white-space:pre-wrap;word-break:break-word;max-height:220px;color:var(--dsw-text-primary);font-size:12px;line-height:1.6;font-family:var(--dsw-font-mono,ui-monospace, monospace);margin:0;overflow:auto}";
		...
		var robot_pane_module_css_default = {
			"section": "NBqibq_section",
			"fieldLabel": "NBqibq_fieldLabel",
			"danger": "NBqibq_danger",
			"overrideRow": "NBqibq_overrideRow",
			"overridePick": "NBqibq_overridePick",
			"overrideName": "NBqibq_overrideName",
			"overrideMeta": "NBqibq_overrideMeta",
			"channelPick": "NBqibq_channelPick",
			"groupCard": "NBqibq_groupCard",
			"addRow": "NBqibq_addRow",
			"detailHead": "NBqibq_detailHead",
			"groupCardHead": "NBqibq_groupCardHead",
			"select": "NBqibq_select",
			"sharePreview": "NBqibq_sharePreview",
			"shareRow": "NBqibq_shareRow",
			"sharePreviewBody": "NBqibq_sharePreviewBody",
			"pane": "NBqibq_pane",
			"groupFiles": "NBqibq_groupFiles",
			"shareMeta": "NBqibq_shareMeta",
			"primary": "NBqibq_primary",
			"input": "NBqibq_input",
			"channelName": "NBqibq_channelName",
			"hint": "NBqibq_hint",
			"shareList": "NBqibq_shareList",
			"dangerActive": "NBqibq_dangerActive",
			"dotOn": "NBqibq_dotOn",
			"groupFilesTitle": "NBqibq_groupFilesTitle",
			"sharePreviewHead": "NBqibq_sharePreviewHead",
			"channelError": "NBqibq_channelError",
			"miniSelect": "NBqibq_miniSelect",
			"channelList": "NBqibq_channelList",
			"actions": "NBqibq_actions",
			"editor": "NBqibq_editor",
			"sectionTitle": "NBqibq_sectionTitle",
			"overrideList": "NBqibq_overrideList",
			"channelRow": "NBqibq_channelRow",
			"note": "NBqibq_note",
			"channelCwd": "NBqibq_channelCwd",
			"textarea": "NBqibq_textarea",
			"routeEditor": "NBqibq_routeEditor",
			"channelMeta": "NBqibq_channelMeta",
			"field": "NBqibq_field",
			"groupCount": "NBqibq_groupCount",
			"shareName": "NBqibq_shareName",
			"secondary": "NBqibq_secondary",
			"shareOpen": "NBqibq_shareOpen",
			"guideBox": "NBqibq_guideBox",
			"dotOff": "NBqibq_dotOff"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/workspace/packages/ui-yzj/src/client/settings-section.module.css.mjs
		const css = ".LLaVTq_section{flex-direction:column;gap:12px;max-width:760px;display:flex}.LLaVTq_switcher{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;align-self:flex-start;gap:4px;padding:4px;display:inline-flex}.LLaVTq_seg,.LLaVTq_segOn{cursor:pointer;border:none;border-radius:7px;padding:8px 16px;font-family:inherit;font-size:12.5px;line-height:1}.LLaVTq_seg{color:var(--dsw-alias-label-secondary);background:0 0}.LLaVTq_seg:hover{color:var(--dsw-alias-label-primary)}.LLaVTq_segOn{background:var(--dsw-static-deepseek-100);color:var(--dsw-static-deepseek-600);font-weight:600}.LLaVTq_content{flex-direction:column;min-height:420px;display:flex}.LLaVTq_content>*{flex:1;min-height:0;max-height:min(70vh,640px);overflow-y:auto}";
		...
		var settings_section_module_css_default = {
			"switcher": "LLaVTq_switcher",
			"section": "LLaVTq_section",
			"seg": "LLaVTq_seg",
			"segOn": "LLaVTq_segOn",
			"content": "LLaVTq_content"
		};
		//#endregion
