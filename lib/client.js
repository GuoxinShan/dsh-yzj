		...
		*/
		...
		function YzjAdvancePane(props) {
			...
			(0, react.useEffect)(() => {
				...
				const tokens = [...new Set(detail.entries.flatMap((entry) => (Array.isArray(entry.refs) ? entry.refs : []).map((ref) => stripRefPrefix(asString$5(ref))).filter((ref) => ref.startsWith("im:"))))];
				if (tokens.length === 0) {
					setRefHits({});
					return;
				}
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									dreamLine !== "" && (0, react_jsx_runtime.jsxs)("span", {
										...
										children: [
											dreamLine,
											dreamEntries.length > 0 && (0, react_jsx_runtime.jsxs)("button", {
												type: "button",
												className: advance_pane_module_css_default.patrolBtn,
								...
								children: [(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										(0, react_jsx_runtime.jsxs)("section", {
											...
											children: [
												(0, react_jsx_runtime.jsxs)("div", {
													className: advance_pane_module_css_default.sectionHead,
													children: [(0, react_jsx_runtime.jsx)("h2", { children: "推进演进" }), (0, react_jsx_runtime.jsx)("small", { children: "事元时间线 · 展开详情看原始来源" })]
												}),
																...
																(0, react_jsx_runtime.jsxs)("div", {
																	...
																	children: [
																		(0, react_jsx_runtime.jsxs)("b", {
																			...
																			children: [asString$5(entry.changeType) !== "" ? `${asString$5(entry.changeType)} · ` : "", asString$5(entry.summary)]
																		}),
																		expanded && asString$5(entry.detail) !== "" && (0, react_jsx_runtime.jsx)("p", { children: asString$5(entry.detail) }),
																		expanded && refList.length > 0 && (0, react_jsx_runtime.jsx)("span", {
																			...
																			children: refList.map((raw) => {
																				...
																				if (kind === "msg") {
																					...
																					if (hit !== void 0) return (0, react_jsx_runtime.jsxs)("button", {
																						type: "button",
																		...
																		(0, react_jsx_runtime.jsxs)("div", {
																			...
																			children: [(0, react_jsx_runtime.jsxs)("span", { children: [asString$5(entry.sourceType), asString$5(entry.actor) === "user" ? " · 你的判断" : ""] }), (0, react_jsx_runtime.jsx)("button", {
																				type: "button",
																				className: advance_pane_module_css_default.jump,
																				"data-testid": `yzj-advance-entry-toggle-${index}`,
																				onClick: toggleExpanded,
																				children: expanded ? "收起详情" : `查看详情${refList.length > 0 ? `（${refList.length} 个来源）` : ""}`
																			})]
																		})
																	]
																})
									...
									children: [(0, react_jsx_runtime.jsxs)("section", {
										...
										children: [
											(0, react_jsx_runtime.jsxs)("div", {
												className: advance_pane_module_css_default.sectionHead,
												children: [(0, react_jsx_runtime.jsx)("h2", { children: "事元" }), (0, react_jsx_runtime.jsx)("small", { children: "跨工作现场" })]
											}),
											detail.sources.length === 0 ? (0, react_jsx_runtime.jsx)("p", {
												...
												children: (showAllSources ? detail.sources : detail.sources.slice(-3)).map((source, index) => {
													...
													const sourceKind = refKindOf(asString$5(source.sourceType));
													...
													return (0, react_jsx_runtime.jsxs)("div", {
														...
														children: [
															...
															(0, react_jsx_runtime.jsxs)("span", {
																...
																}) : sourceKind === "msg" ? (0, react_jsx_runtime.jsx)("button", {
																	type: "button",
																	className: advance_pane_module_css_default.sourceJump,
																	title: `打开来源群消息 ${sourceRef}`,
																	"data-testid": `yzj-advance-source-jump-${index}`,
																	onClick: () => {
																		jumpToSourceMsg(sourceRef);
																	},
																	children: (0, react_jsx_runtime.jsx)("b", { children: asString$5(source.label) })
