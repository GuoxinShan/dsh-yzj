		...
		function TodoPane(props) {
					...
					children: [
						(0, react_jsx_runtime.jsxs)("button", {
							...
							children: [(0, react_jsx_runtime.jsx)("span", {
								...
								children: [
									ddl !== "" && (0, react_jsx_runtime.jsxs)("span", {
									...
									asString$7(todo.priority) !== "" && (0, react_jsx_runtime.jsx)("span", {
										className: todo_pane_module_css_default.chipMuted,
										children: asString$7(todo.priority)
									}),
									asString$7(todo.assignee) !== "" && (0, react_jsx_runtime.jsxs)("span", {
										className: todo_pane_module_css_default.chipMuted,
						...
						description !== "" && !isArchived && status !== "done" && status !== "cancelled" && (0, react_jsx_runtime.jsx)("div", {
							className: todo_pane_module_css_default.cardDesc,
							title: description,
							children: description
						}),
						status === "in_progress" && (0, react_jsx_runtime.jsxs)("div", {
							className: todo_pane_module_css_default.claimBadge,
							children: ["agent 认领中", claimedBy === "" ? "" : ` · ${claimedBy.slice(0, 16)}`]
						}),
						status === "in_review" && reviewNote !== "" && (0, react_jsx_runtime.jsx)("div", {
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								isArchived && (0, react_jsx_runtime.jsx)("button", {
									type: "button",
								...
								!isArchived && status === "backlog" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									(0, react_jsx_runtime.jsx)("button", {
										type: "button",
								...
								!isArchived && status === "todo" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									(0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: `${todo_pane_module_css_default.verb} ${todo_pane_module_css_default.verbPrimary}`,
								...
								!isArchived && status === "in_progress" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									(0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: todo_pane_module_css_default.verb,
										"data-testid": `yzj-todo-done-${todoId}`,
								...
								!isArchived && status === "in_review" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: `${todo_pane_module_css_default.verb} ${todo_pane_module_css_default.verbPrimary}`,
								...
								!isArchived && status === "done" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: todo_pane_module_css_default.verb,
								...
								!isArchived && status === "cancelled" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: todo_pane_module_css_default.verb,
									"data-testid": `yzj-todo-reopen-${todoId}`,
									disabled: busy,
						...
						noteFor !== null && noteFor.todoId === todoId && (0, react_jsx_runtime.jsxs)("div", {
						...
						editFor === todoId && (0, react_jsx_runtime.jsxs)("div", {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					visible.length === 0 && !props.loading ? (0, react_jsx_runtime.jsxs)("div", {
						...
						children: lanes.map((lane) => (0, react_jsx_runtime.jsxs)("section", {
							...
							children: [
								(0, react_jsx_runtime.jsxs)("header", {
									...
									children: [(0, react_jsx_runtime.jsx)("span", { children: lane.label }), (0, react_jsx_runtime.jsx)("span", {
										className: todo_pane_module_css_default.bucketCount,
										children: lane.todos.length
									})]
								}),
								lane.hint !== "" && (0, react_jsx_runtime.jsx)("div", {
									className: todo_pane_module_css_default.laneHint,
									children: lane.hint
								}),
								lane.todos.map(renderCard),
								lane.todos.length === 0 && (0, react_jsx_runtime.jsx)("div", {
					...
					cancelled.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
					...
					archived.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
						className: todo_pane_module_css_default.closedZone,
						children: [(0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							className: todo_pane_module_css_default.closedToggle,
					...
					(0, react_jsx_runtime.jsx)("footer", {
						...
						children: (0, react_jsx_runtime.jsx)("span", { children: "泳道待办：你管批准与验收，agent 认领执行；卡片可直接编辑任务描述——那就是 agent 认领后执行的那段提示词" })
					}),
									...
									children: [
										...
										(0, react_jsx_runtime.jsxs)("section", {
											...
											children: [
												...
												stage === "running" && (0, react_jsx_runtime.jsx)("p", {
													className: advance_pane_module_css_default.quiet,
																	...
																	children: [(0, react_jsx_runtime.jsxs)("button", {
																		...
																		refList.length > 0 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("div", {
																			...
																			children: refList.map((raw) => {
																				...
																				if (kind === "msg" && msgAnchorOf(id) !== null) return (0, react_jsx_runtime.jsx)("button", {
																					type: "button",
																					className: advance_pane_module_css_default.refChip,
																					title: `打开来源群消息 ${raw}`,
																					"data-testid": `yzj-advance-ref-${id}`,
