window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ImBody(meta, openPanel) {
			...
			if (messages.length > 0 && asString$9(asRecord$11(messages[0]).sendTime) !== "") return (0, react_jsx_runtime.jsx)("div", {
				className: cards_module_css_default.rows,
		...
		*/
		function MessageBody({ message, onOpenImage, onOpenPdf, inject }) {
			...
			const msgType = asString$4(message.msgType);
			const param = asRecord$6(message.param);
			if (msgType === "other" && asString$4(param.title) === "" && asRecord$6(param.interactiveCard).cardJson === void 0) return (0, react_jsx_runtime.jsx)("span", {
				className: panel_module_css_default.msgSystem,
				children: content === "" ? "(系统消息)" : emojiText(content)
			});
			if (asString$4(param.sysType) === "withdrawMsg") return (0, react_jsx_runtime.jsx)("span", {
				className: panel_module_css_default.msgSystem,
			...
			*  current month reselects today; other months clear the selection. */
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
							...
							children: [(0, react_jsx_runtime.jsxs)("div", {
								...
								children: state.groupId === "" ? (0, react_jsx_runtime.jsxs)("div", {
									...
									(0, react_jsx_runtime.jsxs)("div", {
										...
										ref: listRef,
										children: [
											state.messages.length === 0 && !state.loading && state.error === "" && (0, react_jsx_runtime.jsx)("div", {
												className: panel_module_css_default.empty,
												children: "暂无消息"
											}),
					...
					lightbox !== null && (0, react_jsx_runtime.jsx)("div", {
						className: panel_module_css_default.lightbox,
						role: "presentation",
						onClick: () => setLightbox(null),
						children: lightbox.kind === "pdf" ? (0, react_jsx_runtime.jsx)("embed", {
		...
		function ArgBody({ record, names }) {
			...
			switch (record.domain) {
				case "im": {
					...
					if (str("content") !== "") rows.push((0, react_jsx_runtime.jsx)("div", {
