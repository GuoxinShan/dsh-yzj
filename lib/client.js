	...
	factory: (require) => {
		...
		*/
		...
		var advance_pane_module_css_default = {
			...
			"entryGroupHead": "Y6ZzqW_entryGroupHead",
		...
		*/
		...
		function groupEntriesByChangeType(entries) {
			const groups = [];
			entries.forEach((entry, index) => {
				const changeType = asString$5(entry.changeType) || "备注";
				const last = groups[groups.length - 1];
				if (last !== void 0 && last.changeType === changeType) last.items.push({
					entry,
					index
				});
				else groups.push({
									...
									children: [
										...
										(0, react_jsx_runtime.jsxs)("section", {
											...
											children: [
												(0, react_jsx_runtime.jsxs)("div", {
													className: advance_pane_module_css_default.sectionHead,
													children: [(0, react_jsx_runtime.jsx)("h2", { children: "推进演进" }), (0, react_jsx_runtime.jsx)("small", { children: "进度节点由多个事元组成 · 事元下挂它引用的原始信息" })]
												}),
												detail.entries.length === 0 ? (0, react_jsx_runtime.jsx)("p", {
													...
													children: groupEntriesByChangeType(detail.entries).map((group, gi) => (0, react_jsx_runtime.jsxs)("div", {
														className: advance_pane_module_css_default.entryGroup,
														"data-testid": `yzj-advance-entry-group-${gi}`,
														children: [(0, react_jsx_runtime.jsxs)("div", {
															className: advance_pane_module_css_default.entryGroupHead,
															children: [(0, react_jsx_runtime.jsx)("b", { children: group.changeType }), (0, react_jsx_runtime.jsxs)("span", { children: [
																group.items.length,
																" 个事元",
																group.items.length > 1 ? ` · ${asString$5(group.items[0]?.entry.at)} → ${asString$5(group.items[group.items.length - 1]?.entry.at)}` : ` · ${asString$5(group.items[0]?.entry.at)}`
															] })]
																...
																children: [
																	...
																	(0, react_jsx_runtime.jsxs)("div", {
																		...
																		children: [
																			...
																			refList.length > 0 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("p", {
																				...
																				children: (expanded ? refList : refList.slice(-2)).map((raw) => {
																					...
																					if (href !== null) {
																						...
																						if (docHit !== void 0 && docHit.content !== "") return (0, react_jsx_runtime.jsxs)("a", {
																			...
																			(0, react_jsx_runtime.jsxs)("div", {
																				...
																				children: [(0, react_jsx_runtime.jsxs)("span", { children: [asString$5(entry.sourceType), asString$5(entry.actor) === "user" ? " · 你的判断" : ""] }), refList.length > 2 && (0, react_jsx_runtime.jsx)("button", {
																					type: "button",
																					className: advance_pane_module_css_default.jump,
																					"data-testid": `yzj-advance-entry-toggle-${index}`,
																					onClick: toggleExpanded,
																					children: expanded ? "收起" : `展开全部 ${refList.length} 条原始信息`
																				})]
																			})
																		]
																	})
