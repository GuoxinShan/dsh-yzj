window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ImBody(meta, openPanel) {
			...
			if (messages.length > 0 && asString$13(asRecord$20(messages[0]).sendTime) !== "") return (0, react_jsx_runtime.jsx)("div", {
				className: cards_module_css_default.rows,
		...
		*/
		function MessageBody({ message, onOpenImage, onOpenPdf, inject }) {
			...
			if (msgType === "other" && asString$10(param.title) === "" && asRecord$13(param.interactiveCard).cardJson === void 0) return (0, react_jsx_runtime.jsx)("span", {
				className: panel_module_css_default.msgSystem,
				children: content === "" ? "(系统消息)" : emojiText(content)
			});
			if (asString$10(param.sysType) === "withdrawMsg") return (0, react_jsx_runtime.jsx)("span", {
				className: panel_module_css_default.msgSystem,
