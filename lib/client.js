					...
					feedOpen && props.advanceState !== void 0 && props.advanceFeed !== void 0 && (0, react_jsx_runtime.jsx)(AdvanceFeedPicker, {
						...
						onSubmit: async (advanceId, summary) => {
							const result = await props.advanceFeed?.({
								...
								summary,
								sourceType: "对话",
								...rootMsgId === void 0 || rootMsgId === "" || rootMsgId === LEGACY_HOST_ROOT ? {} : { refs: [props.groupId === void 0 || props.groupId === "" ? rootMsgId : `im:${props.groupId}:${rootMsgId}`] }
							});
		...
		*/
		function YzjTopicDrawer(props) {
			...
			if (props.lensSessionId !== void 0) return (0, react_jsx_runtime.jsx)(YzjTopicLens, {
				...
				...props.groupId === void 0 ? {} : { groupId: props.groupId },
				lens,
		...
		*/
		function foldPendingRecommendations(entries, subscribedTokens) {
			...
			for (const entry of entries) {
				const summary = asString$5(entry.summary);
				for (const line of asString$5(entry.detail).split("\n")) {
					const trimmed = line.trim();
		...
		function YzjAdvancePane(props) {
			...
			const pendingRecs = (0, react.useMemo)(() => foldPendingRecommendations(detail?.entries ?? [], (detail?.contextSources ?? []).map((row) => asString$5(row.token))), [detail]);
