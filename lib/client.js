	...
	factory: (require) => {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: docResults !== null ? docSearching ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										...
										const rows = state.workspaces.map(asRecord$9);
		...
		*/
		function foldDoneActions(entries) {
			...
			for (const entry of entries) for (const line of asString$5(entry.detail).split("\n")) {
		...
		function YzjAdvancePane(props) {
			...
			*  →效应对象自动订阅。event 无效应对象——留痕后跳日程域，建成后经订阅回流。 */
			const runAction = async (key, action) => {
				...
				const warnings = asArray$6(asRecord$8(result.value).warnings).map(asString$5).filter((row) => row !== "");
			...
			const latestDecision = detail === null ? void 0 : (() => {
				...
				detail.entries.forEach((entry, i) => {
					if (asString$5(entry.judge) !== "") lastJudge = i;
				});
				return detail.entries.reduce((acc, entry, i) => i > lastJudge && asString$5(entry.changeType) === "决策请求" ? entry : acc, void 0);
			})();
											...
											children: [
												...
												stage === "decision-needed" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [latestDecision !== void 0 && decisionParsed !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
														...
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: asString$5(latestDriver.summary) }),
														asString$5(latestDriver.detail) !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: asString$5(latestDriver.detail) }),
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
															className: advance_pane_module_css_default.quiet,
															...
															children: [
																...
																/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
																	...
																	children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
																		...
																		children: [
																			asString$5(entry.changeType) !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
																		...
																		asString$5(entry.detail) !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
																		...
																		refList.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
																			...
																			children: refList.map((raw) => {
																				...
																				if (kind === "msg") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
																					type: "button",
																					className: advance_pane_module_css_default.refChip,
																					title: `打开来源群消息 ${raw}`,
																					"data-testid": `yzj-advance-ref-${id}`,
																		...
																		/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
																			...
																			children: [(() => {
																				...
																				return (origin !== "" || asString$5(entry.actor) === "user") && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: asString$5(entry.actor) === "user" ? `${origin === "" ? "" : `${origin} · `}你的判断` : `记录自 ${origin}` });
																			})(), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
																				type: "button",
