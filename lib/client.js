window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$3 = ".Y6ZzqW_body{flex:1;gap:12px;min-height:0;padding:10px 12px 12px;display:flex;overflow:hidden}.Y6ZzqW_queue{flex-direction:column;flex:0 0 260px;gap:10px;min-height:0;padding-right:4px;display:flex;overflow-y:auto}.Y6ZzqW_queueHead{flex-direction:column;gap:2px;display:flex}.Y6ZzqW_queueHead b{color:var(--dsw-alias-label-primary);font-size:14px}.Y6ZzqW_queueHead span{color:var(--dsw-alias-label-tertiary);font-size:11px}.Y6ZzqW_queueGroup{flex-direction:column;gap:6px;display:flex}.Y6ZzqW_queueLabel{color:var(--dsw-alias-label-secondary);justify-content:space-between;align-items:center;font-size:11px;display:flex}.Y6ZzqW_queueCount{text-align:center;background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l2);min-width:18px;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 5px;font-size:10px}.Y6ZzqW_queueItem{text-align:left;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);cursor:pointer;border-radius:10px;flex-direction:column;gap:3px;padding:8px 10px;transition:border-color .15s,background .15s;display:flex}.Y6ZzqW_queueItem:hover{border-color:var(--dsw-static-deepseek-500)}.Y6ZzqW_queueItemOn{border-color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-100)}.Y6ZzqW_queueTitle{align-items:center;gap:6px;min-width:0;display:flex}.Y6ZzqW_queueTitle b{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;overflow:hidden}.Y6ZzqW_queueItem p{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;margin:0;font-size:11px;overflow:hidden}.Y6ZzqW_queueEmpty{border:1px dashed var(--dsw-alias-border-l2);border-radius:10px;padding:8px 10px}.Y6ZzqW_queueEmpty b{color:var(--dsw-alias-label-secondary);font-size:12px}.Y6ZzqW_queueEmpty p{color:var(--dsw-alias-label-tertiary);margin:2px 0 0;font-size:11px}.Y6ZzqW_dot{background:var(--dsw-alias-border-l2);border-radius:50%;flex:0 0 8px;width:8px;height:8px}.Y6ZzqW_dot_red{background:#e5484d}.Y6ZzqW_dot_blue{background:var(--dsw-static-deepseek-500)}.Y6ZzqW_dot_green{background:#2f9e44}.Y6ZzqW_dot_gray{background:var(--dsw-alias-border-l2)}.Y6ZzqW_detail{flex-direction:column;flex:1;gap:12px;min-width:0;min-height:0;display:flex;overflow-y:auto}.Y6ZzqW_detailHead{flex-direction:column;gap:4px;display:flex}.Y6ZzqW_kicker{color:var(--dsw-alias-label-tertiary);align-items:center;gap:8px;font-size:11px;display:flex}.Y6ZzqW_kickerActions{gap:6px;margin-left:auto;display:flex}.Y6ZzqW_feedbackBtn{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:8px;padding:4px 10px;font-size:12px;font-weight:600}.Y6ZzqW_feedbackBtn:hover{background:var(--dsw-alias-interactive-bg-hover)}.Y6ZzqW_stagePill{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);border-radius:999px;align-items:center;padding:2px 8px;font-size:11px;display:inline-flex}.Y6ZzqW_pill_red{color:#e5484d;border-color:#e5484d}.Y6ZzqW_pill_green{color:#2f9e44;border-color:#2f9e44}.Y6ZzqW_pill_blue{border-color:var(--dsw-static-deepseek-500);color:var(--dsw-static-deepseek-500)}.Y6ZzqW_pill_gray{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.Y6ZzqW_detailHead h1{color:var(--dsw-alias-label-primary);margin:0;font-size:17px;line-height:1.3}.Y6ZzqW_meta{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;gap:10px;font-size:11.5px;display:flex}.Y6ZzqW_meta a{color:var(--dsw-static-deepseek-500);text-decoration:none}.Y6ZzqW_metrics{flex-wrap:wrap;gap:8px;display:flex}.Y6ZzqW_metric{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;flex-direction:column;flex:120px;gap:2px;min-width:120px;padding:8px 10px;display:flex}.Y6ZzqW_metric span{color:var(--dsw-alias-label-tertiary);font-size:11px}.Y6ZzqW_metric b{color:var(--dsw-alias-label-primary);font-size:16px}.Y6ZzqW_metric small{color:var(--dsw-alias-label-tertiary);font-size:10.5px}.Y6ZzqW_detailGrid{align-items:flex-start;gap:12px;display:flex}.Y6ZzqW_main{flex-direction:column;flex:1;gap:12px;min-width:0;display:flex}.Y6ZzqW_side{flex-direction:column;flex:0 0 240px;gap:12px;display:flex}.Y6ZzqW_section{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.Y6ZzqW_sectionHead{justify-content:space-between;align-items:baseline;gap:8px;display:flex}.Y6ZzqW_sectionHead h2{color:var(--dsw-alias-label-primary);margin:0;font-size:13px}.Y6ZzqW_sectionHead small{color:var(--dsw-alias-label-tertiary);font-size:11px}.Y6ZzqW_goal{color:var(--dsw-alias-label-primary);margin:0;font-size:13px;line-height:1.5}.Y6ZzqW_background{color:var(--dsw-alias-label-secondary);margin:0;font-size:12px}.Y6ZzqW_quiet{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px}.Y6ZzqW_decision{flex-direction:column;gap:6px;display:flex}.Y6ZzqW_decision h3{color:var(--dsw-alias-label-primary);margin:0;font-size:13px}.Y6ZzqW_decision p{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;margin:0;font-size:12px}.Y6ZzqW_verbs{flex-wrap:wrap;gap:8px;display:flex}.Y6ZzqW_verbs button{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;padding:6px 12px;font-size:12px}.Y6ZzqW_verbs button:disabled{opacity:.6;cursor:default}.Y6ZzqW_options{flex-direction:column;gap:6px;display:flex}.Y6ZzqW_optionBtn{text-align:left;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:10px;padding:7px 10px;font-size:12px;line-height:1.4;transition:border-color .15s,background .15s}.Y6ZzqW_optionBtn:hover{border-color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-100)}.Y6ZzqW_optionBtn:disabled{opacity:.6;cursor:default}.Y6ZzqW_impact{color:#e8a33d;margin:0;font-size:11.5px}.Y6ZzqW_linkBtn{color:var(--dsw-static-deepseek-500);cursor:pointer;background:0 0;border:none;padding:0;font-size:11.5px}.Y6ZzqW_linkBtn:disabled{opacity:.6;cursor:default}.Y6ZzqW_threads{flex-direction:column;gap:6px;display:flex}.Y6ZzqW_threadChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:999px;align-items:center;gap:6px;min-width:0;padding:3px 6px 3px 4px;display:flex}.Y6ZzqW_threadIcon{background:var(--dsw-static-deepseek-100);width:18px;height:18px;color:var(--dsw-static-deepseek-500);border-radius:50%;flex:0 0 18px;justify-content:center;align-items:center;font-size:10px;font-style:normal;display:inline-flex}.Y6ZzqW_threadChip b{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:11.5px;overflow:hidden}.Y6ZzqW_threadChip em{color:var(--dsw-alias-label-tertiary);flex:none;font-size:10px;font-style:normal}.Y6ZzqW_threadChip button{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;flex:none;padding:2px 4px;font-size:12px;line-height:1}.Y6ZzqW_threadChip button:hover{color:#e5484d;background:var(--dsw-alias-interactive-bg-hover)}.Y6ZzqW_threadGroupList{flex-wrap:wrap;gap:6px;max-height:160px;display:flex;overflow-y:auto}.Y6ZzqW_threadGroupList button{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;padding:4px 10px;font-size:11.5px}.Y6ZzqW_threadGroupList button:hover{border-color:var(--dsw-static-deepseek-500)}.Y6ZzqW_threadGroupList button:disabled{opacity:.6;cursor:default}.Y6ZzqW_timeline{flex-direction:column;gap:10px;display:flex}.Y6ZzqW_timeItem{align-items:flex-start;gap:8px;display:flex}.Y6ZzqW_time{color:var(--dsw-alias-label-tertiary);flex:none;min-width:96px;padding-top:2px;font-size:10.5px}.Y6ZzqW_mark{border-radius:50%;flex:0 0 8px;width:8px;height:8px;margin-top:4px}.Y6ZzqW_mark_blue{background:var(--dsw-static-deepseek-500)}.Y6ZzqW_mark_green{background:#2f9e44}.Y6ZzqW_mark_red{background:#e5484d}.Y6ZzqW_timeCopy{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.Y6ZzqW_timeCopy b{color:var(--dsw-alias-label-primary);font-size:12.5px}.Y6ZzqW_timeCopy p{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;margin:0;font-size:11.5px}.Y6ZzqW_timeMeta{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;align-items:center;gap:8px;font-size:10.5px;display:flex}.Y6ZzqW_refs{text-overflow:ellipsis;white-space:nowrap;max-width:240px;overflow:hidden}.Y6ZzqW_jump{color:var(--dsw-static-deepseek-500);cursor:pointer;background:0 0;border:none;padding:0;font-size:10.5px}.Y6ZzqW_more{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;border-radius:999px;align-self:flex-start;padding:5px 12px;font-size:11.5px}.Y6ZzqW_sourceList{flex-direction:column;gap:8px;display:flex}.Y6ZzqW_source{align-items:center;gap:8px;min-width:0;display:flex}.Y6ZzqW_sourceIcon{background:var(--dsw-static-deepseek-100);width:22px;height:22px;color:var(--dsw-static-deepseek-500);border-radius:6px;flex:0 0 22px;justify-content:center;align-items:center;font-size:11px;display:inline-flex}.Y6ZzqW_sourceCopy{flex-direction:column;flex:1;min-width:0;display:flex}.Y6ZzqW_sourceCopy b{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11.5px;overflow:hidden}.Y6ZzqW_sourceCopy span{color:var(--dsw-alias-label-tertiary);font-size:10px}.Y6ZzqW_sourceState{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary);border-radius:999px;flex:none;padding:1px 6px;font-size:10px;font-style:normal}.Y6ZzqW_state_已确认{color:#2f9e44;border-color:#2f9e44}.Y6ZzqW_state_未达标{color:#e5484d;border-color:#e5484d}.Y6ZzqW_state_等待中{color:#e8a33d;border-color:#e8a33d}.Y6ZzqW_sideNote{color:var(--dsw-alias-label-tertiary);margin:0;font-size:10.5px;line-height:1.5}.Y6ZzqW_hero{text-align:center;flex-direction:column;align-items:center;gap:8px;max-width:380px;margin:auto;display:flex}.Y6ZzqW_hero h2{color:var(--dsw-alias-label-primary);margin:0;font-size:15px}.Y6ZzqW_hero p{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px}.Y6ZzqW_hint{color:var(--dsw-alias-label-tertiary);margin:auto;font-size:12px}.Y6ZzqW_primary{background:var(--dsw-static-deepseek-500);color:#fff;cursor:pointer;border:none;border-radius:999px;padding:7px 16px;font-size:12.5px}.Y6ZzqW_primary:disabled{opacity:.6;cursor:default}.Y6ZzqW_error{color:#e5484d;font-size:11.5px}.Y6ZzqW_mask{z-index:40;background:#00000059;justify-content:center;align-items:center;display:flex;position:absolute;inset:0}.Y6ZzqW_modal{background:var(--dsw-alias-bg-base);border:1px solid var(--dsw-alias-border-l2);border-radius:14px;flex-direction:column;gap:10px;width:min(480px,92%);max-height:86%;padding:14px 16px;display:flex;overflow-y:auto}.Y6ZzqW_modalHead{justify-content:space-between;align-items:center;display:flex}.Y6ZzqW_modalHead h2{color:var(--dsw-alias-label-primary);margin:0;font-size:14px}.Y6ZzqW_modalHead button{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;font-size:16px}.Y6ZzqW_fieldLabel{color:var(--dsw-alias-label-secondary);flex-direction:column;gap:4px;font-size:11.5px;display:flex}.Y6ZzqW_fieldLabel input,.Y6ZzqW_fieldLabel textarea{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);resize:vertical;border-radius:8px;padding:7px 9px;font-size:12.5px}.Y6ZzqW_fieldLabel textarea{min-height:56px}.Y6ZzqW_fieldRow{gap:10px;display:flex}.Y6ZzqW_fieldRow .Y6ZzqW_fieldLabel{flex:1}.Y6ZzqW_modalFoot{justify-content:flex-end;gap:8px;display:flex}.Y6ZzqW_modalFoot button{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;padding:6px 14px;font-size:12px}.Y6ZzqW_modalFoot .Y6ZzqW_primary{background:var(--dsw-static-deepseek-500);color:#fff;border:none}";
		...
		var advance_pane_module_css_default = {
			...
			"threadGroupList": "Y6ZzqW_threadGroupList",
