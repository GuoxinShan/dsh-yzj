...
function applySummonWindow(ctx, home) {
	...
	ctx.effect(() => systemPrompt.context({
		...
		text: (assemble) => {
			...
			return home.formatSummonWindow(conversationId, void 0, sessionId);
		}
	}));
}
/**
...
//#endregion
export { BoundLogStore, Config, DEFAULT_BOUND_LOG_LIMITS, HomeBindingStore, TopicAnchorStore, ackLocalEntry, apply, applyAppend, cliMessageList, cliMessageToEntry, clipLogParam, conversationKindOf, extractSendMsgId, failLocalEntry, formatSummonWindow, homeSessionId, inject, isPluginFollowup, latestUserSourceKind, localMsgId, mergeFused, name, robotOutboundEntry, sessionIdFromAssemble, topicAnchorKey, topicSessionId, yzjHomeDomainSpec, yzjHomeLogDomainSpec, yzjTopicDomainSpec };
