...
describe('openBoundHome', () => {
  ...
  it('mints 历史对话 when the host already has ③④; second open is focus', async () => {
    ...
    const first = await openBoundHome({ home, agents, yzjConversationId: 'g-a', cwd: '/tmp', title: '金蝶最小DSH交流群' })
    ...
    const second = await openBoundHome({ home, agents, yzjConversationId: 'g-a', cwd: '/tmp', title: '金蝶最小DSH交流群' })
...
describe('topicSidebarTitle', () => {
  it('suffixes the group name once (either affix direction is idempotent)', () => {
    expect(topicSidebarTitle('金蝶最小DSH交流群', '帮我整理')).toBe('帮我整理 · 金蝶最小DSH交流群')
    expect(topicSidebarTitle('金蝶最小DSH交流群', '帮我整理 · 金蝶最小DSH交流群')).toBe('帮我整理 · 金蝶最小DSH交流群')
    expect(topicSidebarTitle('金蝶最小DSH交流群', '金蝶最小DSH交流群 · 帮我整理')).toBe('金蝶最小DSH交流群 · 帮我整理')
