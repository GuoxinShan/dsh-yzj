  ...
  it('prefixes 话题· when topic activity is newer than the last group message', () => {
    const rows = buildConvRows(
      ...
      [{
        ...
        groupName: '金蝶最小DSH交流群',
        yzjKind: 'group',
        topics: [{ sessionId: 'yzj-topic-1', title: '整理接口', lastActivity: Date.parse('2026-08-17T12:00:00') }],
      }],
    )
  ...
  it('keeps the group preview when the group message is newer', () => {
    const rows = buildConvRows(
      ...
      [{
        ...
        groupName: '群A',
        yzjKind: 'group',
        topics: [{ sessionId: 'yzj-topic-1', title: '旧话题', lastActivity: Date.parse('2026-08-17T10:00:00') }],
      }],
    )
