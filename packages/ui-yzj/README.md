...
- **Workbench domains** — top underline tabs 对话 / 待办 / 日程 / 知识库 (R31 / Lingee calendar-page tabs). 对话 is the session list + group-room timeline; 待办 / 知识库 embed the former panel. 日程 is day/week/month/year (`.cal` toolbar + time grid). Memory UI is deferred. The sidebar has one 「云之家」entry; it does not switch domains.
