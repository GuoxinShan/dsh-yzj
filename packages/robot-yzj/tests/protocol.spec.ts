    ...
    const raw = JSON.stringify({
      msg: {
        ...
        msgParam: JSON.stringify({
          ...
          replyPersonName: '测试用户', replyRootMsgId: '6a80c81ce4b0ab2391c26127',
          replySummary: '测试入站2**',
        }),
        robotId: 'BOT-test-assistabe4b0298ccdfc1c91', type: 2,
        operatorName: '测试用户', content: '1', operatorOpenid: '64a7',
        time: 1786824826346,
      },
