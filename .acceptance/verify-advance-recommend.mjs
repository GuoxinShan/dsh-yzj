...
await page.getByTestId('yzj-advance-recommend-add-im-gid-dsh2').click()
...
await page.getByTestId('yzj-advance-recommend-ignore-im-gid-dsh2').click()
await page.waitForTimeout(8000)
...
ok('推荐事元落库（探针 1）', JSON.stringify(dump1.entries).includes('推荐订阅: im:gid-dsh2'))
ok('忽略事元落库（探针 2）', JSON.stringify(dump2.entries).includes('推荐忽略: im:gid-dsh2'))
