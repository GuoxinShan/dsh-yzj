/**
 * 存量 3 份速记纪要 → 830 事项事元(决策 40 落地动作②):打开 830 群话题,
...
const DOCS = [
  { id: '6a86d826fcb8644499541e2b', name: 'AI推进业务设计启动会纪要-总结' },
  { id: '6a86d125ecd3fb103b85b577', name: 'AI推进系统产品讨论会-总结' },
  { id: '6a86ca01ecd3fb103b85b442', name: 'AI推进工具产品设计研讨会-总结' },
]
