...
const groupBtn = page.getByTestId('yzj-advance-source-group-6a8400d4e4b09a073e3feeaf')
...
const other = page.getByTestId('yzj-advance-queue').locator('button').filter({ hasText: '830' }).first()
...
ok('A4f 执行事元 refs 含 im:g:m', /6a8400d4e4b09a073e3feeaf[^"\s]*:/.test(streamText) || streamText.includes('im:6a8400d4e4b09a073e3feeaf:'), '')
