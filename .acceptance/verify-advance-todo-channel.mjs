/**
 * 真机验证：接水源（830 群 + AI速记知识库）+ todo 渠道采集器（决策 45 后续，
 * gap §24.28 断层补钉）。
 *
 * Journey: 830 事项关联 im:830群 + dir:AI速记知识库整库 → 新建「回流探针」
...
const GROUP_830 = '6a605c7ce4b0772a6279295e'
const KB_MINUTES = '6a7442666d7c9d16928311d3' // AI速记知识库（整库）
...
ok('830 事项挂上 830 群', afterSources.includes('830 项目'))
ok('830 事项挂上纪要库', afterSources.includes('AI速记知识库'))
...
// ---------- 3. 巡检建基线（im:830 / dir:纪要库 / todo:探针待办） ----------
