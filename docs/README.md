...
| 旧路径（已迁移） | 新路径 |
|---|---|
| `docs/云之家-dsh集成整体方案.md` | `docs/spec/integration-master-plan.md` |
| `docs/待办功能设计.md` | `docs/spec/todo-design.md` |
| `docs/机器人通道调研与双向打通方案.md` | `docs/spec/robot-channel-plan.md` |
| `docs/待办后端迁移说明.md` | `docs/migration/todo-backend-migration.md` |
| `docs/gap-设计方案与实现对照.md` | `docs/status/gap-analysis.md` |
| `docs/踩坑记录/`（曾用名） | `docs/pitfalls/` |
