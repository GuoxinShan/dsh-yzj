...
> 版本：v1.7（**§17 Dream 蓄水池落地，决策 33/34**；v1.6 = ④期知识沉淀出口 §16 + 决策 26–31 含第七态 `cancelled`；v1.5 = 意图线程一等化（v1.7 决策 32 加 dir: 目录级订阅）；v1.4 = 主动发现 scan → inspect → feed 巡检回路，见 §14；v1.3 = 打扰判据 + 确认卡门控线收窄，见 §13）
